...
truncated93:                                         ; pred = %inline759, %inline758
...
inline765:                                           ; pred = %truncated95
  %tmp__of_inline765 = sub i32 0, %func3
  store i32 %tmp__of_inline765, i32* %retVal_ofinline765, align 4
  br label %truncated96

truncated96:                                         ; pred = %inline765
...
truncated98:                                         ; pred = %inline768, %inline769
  %func7$1 = load i32, i32* %retVal_ofinline767, align 4
  br label %inline770

inline767:                                           ; pred = %truncated97
...
truncated99:                                         ; pred = %inline771, %inline772
...
truncated100:                                        ; pred = %inline775, %inline776
  %func7$2 = load i32, i32* %retVal_ofinline774, align 4
  %func2$1 = call i32 @func2(i32 %arr$10, i32 %func7$2)
  br label %inline777

inline774:                                           ; pred = %truncated99
  %tmp__of_inline774 = icmp ne i32 0, %arr$12
...
truncated101:                                        ; pred = %inline778, %inline779
...
truncated103:                                        ; pred = %inline784, %inline785
...
truncated104:                                        ; pred = %inline788, %inline787
...
inline790:                                           ; pred = %truncated105
  %tmp__of_inline790 = sub i32 0, %arr$34
  store i32 %tmp__of_inline790, i32* %retVal_ofinline790, align 4
  br label %truncated106

truncated107:                                        ; pred = %inline793, %inline792
...
inline791:                                           ; pred = %truncated106
  %tmp__of_inline791 = icmp ne i32 0, %arr$38
...
inline794:                                           ; pred = %truncated107
  %tmp__of_inline794 = sub i32 0, %arr$40
