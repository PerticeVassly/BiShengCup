...
define i32 @main() {
mainEntry77:
  %retVal_ofil2130 = alloca i32, align 4
  %lv$9_of_il2130 = alloca i32, align 4
...
il2132:                                               ; pred = %il2131
  ...
  %i$2_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %a0_of_il2132 = getelementptr float, float* %a0$1, i32 %i$2_of_il2132
  %a0$1_of_il2132 = load float, float* %a0_of_il2132, align 4
  %i$3_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %b0_of_il2132 = getelementptr float, float* %b0$1, i32 %i$3_of_il2132
  %b0$1_of_il2132 = load float, float* %b0_of_il2132, align 4
  %result__of_il2132 = fsub float %a0$1_of_il2132, %b0$1_of_il2132
  store float %result__of_il2132, float* %c0_of_il2132, align 4
  %i$4_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %c1_of_il2132 = getelementptr float, float* %c1, i32 %i$4_of_il2132
  %i$5_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %a1_of_il2132 = getelementptr float, float* %a1$1, i32 %i$5_of_il2132
  %a1$1_of_il2132 = load float, float* %a1_of_il2132, align 4
  %i$6_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %b1_of_il2132 = getelementptr float, float* %b1$1, i32 %i$6_of_il2132
  %b1$1_of_il2132 = load float, float* %b1_of_il2132, align 4
  %result_$1_of_il2132 = fsub float %a1$1_of_il2132, %b1$1_of_il2132
  store float %result_$1_of_il2132, float* %c1_of_il2132, align 4
  %i$7_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %c2_of_il2132 = getelementptr float, float* %c2, i32 %i$7_of_il2132
  %i$8_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %a2_of_il2132 = getelementptr float, float* %a2$1, i32 %i$8_of_il2132
  %a2$1_of_il2132 = load float, float* %a2_of_il2132, align 4
  %i$9_of_il2132 = load i32, i32* %lv$9_of_il2130, align 4
  %b2_of_il2132 = getelementptr float, float* %b2$1, i32 %i$9_of_il2132
  %b2$1_of_il2132 = load float, float* %b2_of_il2132, align 4
  %result_$2_of_il2132 = fsub float %a2$1_of_il2132, %b2$1_of_il2132
  store float %result_$2_of_il2132, float* %c2_of_il2132, align 4
