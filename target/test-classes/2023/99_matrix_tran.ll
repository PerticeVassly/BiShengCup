...
define i32 @main() {
mainEntry19:
  %retVal_ofil238 = alloca i32, align 4
  %lv$9_of_il238 = alloca i32, align 4
...
il238:                                               ; pred = %next_100
  store i32 0, i32* %lv$9_of_il238, align 4
  %c1_of_il238 = getelementptr float, float* %c1, i32 2
  %a2_of_il238 = getelementptr float, float* %a2$1, i32 1
  %a2$1_of_il238 = load float, float* %a2_of_il238, align 4
  store float %a2$1_of_il238, float* %c1_of_il238, align 4
  %c2_of_il238 = getelementptr float, float* %c2, i32 1
  %a1_of_il238 = getelementptr float, float* %a1$1, i32 2
  %a1$1_of_il238 = load float, float* %a1_of_il238, align 4
  store float %a1$1_of_il238, float* %c2_of_il238, align 4
  %c0_of_il238 = getelementptr float, float* %c0, i32 1
  %a1$2_of_il238 = getelementptr float, float* %a1$1, i32 0
  %a1$3_of_il238 = load float, float* %a1$2_of_il238, align 4
  store float %a1$3_of_il238, float* %c0_of_il238, align 4
  %c0$1_of_il238 = getelementptr float, float* %c0, i32 2
  %a2$2_of_il238 = getelementptr float, float* %a2$1, i32 0
  %a2$3_of_il238 = load float, float* %a2$2_of_il238, align 4
  store float %a2$3_of_il238, float* %c0$1_of_il238, align 4
  %c1$1_of_il238 = getelementptr float, float* %c1, i32 0
  %a0_of_il238 = getelementptr float, float* %a0$1, i32 1
  %a0$1_of_il238 = load float, float* %a0_of_il238, align 4
  store float %a0$1_of_il238, float* %c1$1_of_il238, align 4
  %c2$1_of_il238 = getelementptr float, float* %c2, i32 0
  %a0$2_of_il238 = getelementptr float, float* %a0$1, i32 2
  %a0$3_of_il238 = load float, float* %a0$2_of_il238, align 4
  store float %a0$3_of_il238, float* %c2$1_of_il238, align 4
  %c1$2_of_il238 = getelementptr float, float* %c1, i32 1
  %a1$4_of_il238 = getelementptr float, float* %a1$1, i32 1
  %a1$5_of_il238 = load float, float* %a1$4_of_il238, align 4
  store float %a1$5_of_il238, float* %c1$2_of_il238, align 4
  %c2$2_of_il238 = getelementptr float, float* %c2, i32 2
  %a2$4_of_il238 = getelementptr float, float* %a2$1, i32 2
  %a2$5_of_il238 = load float, float* %a2$4_of_il238, align 4
  store float %a2$5_of_il238, float* %c2$2_of_il238, align 4
  %c0$2_of_il238 = getelementptr float, float* %c0, i32 0
  %a0$4_of_il238 = getelementptr float, float* %a0$1, i32 0
  %a0$5_of_il238 = load float, float* %a0$4_of_il238, align 4
  store float %a0$5_of_il238, float* %c0$2_of_il238, align 4
  store i32 0, i32* %retVal_ofil238, align 4
  br label %tc44

tc44:                                                ; pred = %il238
  %tran = load i32, i32* %retVal_ofil238, align 4
