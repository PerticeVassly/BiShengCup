; ModuleID = './src/test/resources/syslib.c'
source_filename = "./src/test/resources/syslib.c"
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @getfarray(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store ptr %0, ptr %2, align 8
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (ptr, ...) @scanf(ptr noundef @.str.2, ptr noundef %14)
  br label %16
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @putfloat(float noundef %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @putfarray(i32 noundef %0, ptr noundef %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca ptr, align 8
  %5 = alloca i32, align 4
  store i32 %0, ptr %3, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @putf(ptr noundef %0, ...) #0 {
  %2 = alloca ptr, align 8
  ...
  %7 = call i32 @vfprintf(ptr noundef %4, ptr noundef %5, ptr noundef %6)
...
attributes #3 = { noinline nounwind ssp uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+complxnum,+crc,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+jsconv,+lse,+neon,+pauth,+ras,+rcpc,+rdm,+sha2,+sha3,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
