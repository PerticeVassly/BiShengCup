...
whileCond_265:                                        ; pred = %addEntry, %whileBody_265
  ...
  br i1 %cond_, label %whileBody_265, label %next_587
...
whileCond_266:                                        ; pred = %mainEntry83, %whileBody_266
  %i = load i32, i32* %lv$9, align 4
  %M = load i32, i32* @gv, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, %M
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_266, label %next_588
