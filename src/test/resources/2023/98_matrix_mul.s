...
next_144:
	...
	# get address of local var:result_i756
	fsw fs0, 1004(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$2i756
	fsw fs0, 972(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$5i756
	fsw fs0, 908(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$7i756
	fsw fs0, 876(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$10i756
	fsw fs0, 812(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$12i756
	fsw fs0, 780(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$15i756
	fsw fs0, 716(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$17i756
	fsw fs0, 684(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$20i756
	fsw fs0, 620(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$22i756
	fsw fs0, 588(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$25i756
	fsw fs0, 524(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$27i756
	fsw fs0, 492(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$30i756
	fsw fs0, 428(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$32i756
	fsw fs0, 396(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$35i756
	fsw fs0, 332(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$37i756
	fsw fs0, 300(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$40i756
	fsw fs0, 236(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
	...
	# get address of local var:result_$42i756
	fsw fs0, 204(sp)
	fmv.x.w t1, ft0
	fmv.w.x fs0, t1
