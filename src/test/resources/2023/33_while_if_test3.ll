...
whileCond_186:                                           ; pred = %deepWhileBrEntry, %next_455
  %c = load i32, i32* %lv$2, align 4
  %cond_lt_tmp_ = icmp slt i32 %c, 75
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_186, label %next_454
...
whileBody_186:                                           ; pred = %whileCond_186
  ...
  br i1 %cond_$1, label %ifTrue_268, label %next_455

next_454:                                                ; pred = %whileCond_186
  %c$4 = load i32, i32* %lv$2, align 4
  ret i32 %c$4

ifTrue_268:                                              ; pred = %whileBody_186
  ...
  br i1 %cond_$2, label %ifTrue_269, label %next_456

next_455:                                                ; pred = %whileBody_186, %next_456
  br label %whileCond_186

ifTrue_269:                                              ; pred = %ifTrue_268
  %d$1 = load i32, i32* %lv$3, align 4
  %result_$2 = mul i32 %d$1, 2
  store i32 %result_$2, i32* %lv$4, align 4
  br i1 true, label %ifTrue_270, label %next_457

next_456:                                                ; pred = %ifTrue_268, %next_457
  br label %next_455
...
next_457:                                                ; pred = %ifTrue_269, %ifTrue_270
  br label %next_456
}
