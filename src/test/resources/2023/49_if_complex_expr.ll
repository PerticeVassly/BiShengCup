...
ifTrue_46:                                            ; pred = %mainEntry18, %secondCond_34, %secondCond_34
  %result = load i32, i32* %lv$4, align 4
  call void @putint(i32 %result)
  br label %next_98

next_98:                                              ; pred = %secondCond_33, %secondCond_34, %secondCond_34, %ifTrue_46
...
secondCond_34:                                        ; pred = %secondCond_33
  ...
  br i1 %cond_normalize_, label %ifTrue_46, label %next_98

ifTrue_47:                                            ; pred = %next_98, %secondCond_36, %secondCond_36
  store i32 4, i32* %lv$4, align 4
  %result$1 = load i32, i32* %lv$4, align 4
  call void @putint(i32 %result$1)
  br label %next_99

next_99:                                              ; pred = %secondCond_35, %secondCond_36, %secondCond_36, %ifTrue_47
  ret i32 0
...
secondCond_36:                                        ; pred = %secondCond_35
  ...
  br i1 %cond_normalize_$1, label %ifTrue_47, label %next_99
}
