...
mainEntry6:
  ...
  br i1 %cond_, label %ifTrue_3, label %secondCond_4

ifTrue_3:                                            ; pred = %mainEntry6, %secondCond_5, %secondCond_5
  %result = load i32, i32* %lv$4, align 4
  call void @putint(i32 %result)
  br label %next_6

next_6:                                              ; pred = %secondCond_4, %secondCond_5, %secondCond_5, %ifTrue_3
  ...
  br i1 %cond_$3, label %ifTrue_4, label %secondCond_6

secondCond_4:                                        ; pred = %mainEntry6
  ...
  br i1 %cond_$1, label %secondCond_5, label %next_6

secondCond_5:                                        ; pred = %secondCond_4
  ...
  br i1 %cond_normalize_, label %ifTrue_3, label %next_6

ifTrue_4:                                            ; pred = %next_6, %secondCond_7, %secondCond_7
  store i32 4, i32* %lv$4, align 4
  %result$1 = load i32, i32* %lv$4, align 4
  call void @putint(i32 %result$1)
  br label %next_7

next_7:                                              ; pred = %secondCond_6, %secondCond_7, %secondCond_7, %ifTrue_4
  ret i32 0

secondCond_6:                                        ; pred = %next_6
  ...
  br i1 %cond_$4, label %secondCond_7, label %next_7

secondCond_7:                                        ; pred = %secondCond_6
  ...
  br i1 %cond_$5, label %ifTrue_4, label %next_7
  %cond_normalize_$1 = icmp ne i32 0, 0
  br i1 %cond_normalize_$1, label %ifTrue_4, label %next_7
}
