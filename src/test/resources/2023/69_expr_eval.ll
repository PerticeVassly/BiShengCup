...
is_spaceEntry:
  ...
  br i1 %cond_, label %ifTrue_293, label %secondCond_113

ifTrue_293:                                            ; pred = %is_spaceEntry, %secondCond_113
  ret i32 1

ifFalse_112:                                           ; pred = %secondCond_113
  ret i32 0

secondCond_113:                                        ; pred = %is_spaceEntry
  %c$1 = load i32, i32* %lv, align 4
  %cond_eq_tmp_$1 = icmp eq i32 %c$1, 10
  %cond_tmp_$1 = zext i1 %cond_eq_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_293, label %ifFalse_112
}
...
is_numEntry:
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %secondCond_114, label %ifFalse_113

ifTrue_294:                                            ; pred = %secondCond_114
  ret i32 1

ifFalse_113:                                           ; pred = %is_numEntry, %secondCond_114
  ret i32 0

secondCond_114:                                        ; pred = %is_numEntry
  %c$1 = load i32, i32* %lv, align 4
  %cond_le_tmp_ = icmp sle i32 %c$1, 57
  %cond_tmp_$1 = zext i1 %cond_le_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_294, label %ifFalse_113
}
...
get_op_precEntry:
  ...
  %cond_tmp_ = zext i1 %cond_eq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_296, label %secondCond_115

ifTrue_296:                                              ; pred = %get_op_precEntry, %secondCond_115
  ret i32 10

next_498:                                                ; pred = %secondCond_115
  %op$2 = load i32, i32* %lv, align 4
  %cond_eq_tmp_$2 = icmp eq i32 %op$2, 42
  %cond_tmp_$2 = zext i1 %cond_eq_tmp_$2 to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %ifTrue_297, label %secondCond_117

secondCond_115:                                          ; pred = %get_op_precEntry
  %op$1 = load i32, i32* %lv, align 4
  %cond_eq_tmp_$1 = icmp eq i32 %op$1, 45
  %cond_tmp_$1 = zext i1 %cond_eq_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_296, label %next_498

ifTrue_297:                                              ; pred = %next_498, %secondCond_117, %secondCond_116
  ret i32 20

next_499:                                                ; pred = %secondCond_116
  ret i32 0
...
secondCond_116:                                          ; pred = %secondCond_117
  ...
  br i1 %cond_$4, label %ifTrue_297, label %next_499

secondCond_117:                                          ; pred = %next_498
  %op$3 = load i32, i32* %lv, align 4
  %cond_eq_tmp_$3 = icmp eq i32 %op$3, 47
  %cond_tmp_$3 = zext i1 %cond_eq_tmp_$3 to i32
  %cond_$3 = icmp ne i32 %cond_tmp_$3, 0
  br i1 %cond_$3, label %ifTrue_297, label %secondCond_116
}
...
eval_opEntry:
  ...
  %cond_tmp_ = zext i1 %cond_eq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_298, label %next_500

ifTrue_298:                                          ; pred = %eval_opEntry
  %lhs = load i32, i32* %lv$1, align 4
  %rhs = load i32, i32* %lv$2, align 4
  %result_ = add i32 %lhs, %rhs
  ret i32 %result_

next_500:                                            ; pred = %eval_opEntry
  %op$1 = load i32, i32* %lv, align 4
  %cond_eq_tmp_$1 = icmp eq i32 %op$1, 45
  %cond_tmp_$1 = zext i1 %cond_eq_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_299, label %next_501

ifTrue_299:                                          ; pred = %next_500
...
next_501:                                            ; pred = %next_500
  ...
  %cond_tmp_$2 = zext i1 %cond_eq_tmp_$2 to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %ifTrue_300, label %next_502

ifTrue_300:                                          ; pred = %next_501
...
evalEntry:
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_303, label %next_505

ifTrue_303:                                            ; pred = %evalEntry
  %panic = call i32 @panic()
  ret i32 %panic

next_505:                                              ; pred = %evalEntry
...
whileCond_202:                                         ; pred = %next_505, %next_509
  %cur_token$1 = load i32, i32* @gv3, align 4
  %cond_eq_tmp_ = icmp eq i32 %cur_token$1, 1
  %cond_tmp_$1 = zext i1 %cond_eq_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_202, label %next_506
...
whileBody_202:                                         ; pred = %whileCond_202
  ...
  br i1 %cond_normalize_, label %ifTrue_304, label %next_507

next_506:                                              ; pred = %whileCond_202, %ifTrue_304
  %next_token$3 = call i32 @next_token()
  br label %whileCond_204

ifTrue_304:                                            ; pred = %whileBody_202
  br label %next_506
  br label %next_507

next_507:                                              ; pred = %whileBody_202, %ifTrue_304
  %next_token$1 = call i32 @next_token()
  br label %whileCond_203

whileCond_203:                                         ; pred = %next_507, %whileBody_203
  ...
  br i1 %cond_normalize_$1, label %secondCond_118, label %next_508

whileBody_203:                                         ; pred = %secondCond_118
...
next_508:                                              ; pred = %whileCond_203, %secondCond_118
  ...
  %cond_$3 = icmp ne i32 %cond_tmp_$3, 0
  br i1 %cond_$3, label %ifTrue_305, label %next_509

secondCond_118:                                        ; pred = %whileCond_203
  ...
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %whileBody_203, label %next_508

ifTrue_305:                                            ; pred = %next_508
  %panic$1 = call i32 @panic()
  ret i32 %panic$1

next_509:                                              ; pred = %next_508
...
whileCond_204:                                         ; pred = %next_506, %whileBody_204
  ...
  br i1 %cond_normalize_$2, label %whileBody_204, label %next_510
...
whileCond_205:                                        ; pred = %mainEntry61, %whileBody_205
  %count = load i32, i32* %lv, align 4
  %cond_normalize_ = icmp ne i32 %count, 0
  br i1 %cond_normalize_, label %whileBody_205, label %next_511
