...
@gv = global i32 18, align 4
@gv1 = global i32 1000000007, align 4
@gv2 = global [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]] zeroinitializer, align 4
@gv3 = global [200 x i32] zeroinitializer, align 4
@gv4 = global [20 x i32] zeroinitializer, align 4
...
dfsEntry:
  ...
  %ptr_ = getelementptr [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]], [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]]* @gv2, i32 0, i32 %a$1
...
ifTrue_74:                                        ; pred = %dfsEntry
  ...
  %ptr_$5 = getelementptr [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]], [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]]* @gv2, i32 0, i32 %a$2
...
ifTrue_77:                                        ; pred = %next_158
  ...
  %mod$1 = load i32, i32* @gv1, align 4
...
ifTrue_78:                                        ; pred = %next_159
  ...
  %mod$2 = load i32, i32* @gv1, align 4
...
ifTrue_79:                                        ; pred = %next_160
  ...
  %mod$3 = load i32, i32* @gv1, align 4
...
ifTrue_80:                                        ; pred = %next_161
  ...
  %mod$4 = load i32, i32* @gv1, align 4
  %result_$31 = srem i32 %result_$30, %mod$4
  store i32 %result_$31, i32* %lv, align 4
  br label %next_162
...
next_162:                                         ; pred = %next_161, %ifTrue_80
  ...
  %ptr_$10 = getelementptr [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]], [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]]* @gv2, i32 0, i32 %a$11
  ...
  %mod$5 = load i32, i32* @gv1, align 4
  %result_$32 = srem i32 %ans$5, %mod$5
  ...
  %ptr_$15 = getelementptr [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]], [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]]* @gv2, i32 0, i32 %a$12
...
whileCond_83:                                        ; pred = %whileBody_82, %next_165
  ...
  %maxn$1 = load i32, i32* @gv, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %j, %maxn$1
...
whileCond_84:                                        ; pred = %whileBody_83, %next_166
  ...
  %maxn$2 = load i32, i32* @gv, align 4
  %cond_lt_tmp_$2 = icmp slt i32 %k, %maxn$2
...
whileCond_85:                                        ; pred = %whileBody_84, %next_167
  ...
  %maxn$3 = load i32, i32* @gv, align 4
  %cond_lt_tmp_$3 = icmp slt i32 %l, %maxn$3
...
whileCond_86:                                        ; pred = %whileBody_85, %next_168
  ...
  %maxn$4 = load i32, i32* @gv, align 4
  %cond_lt_tmp_$4 = icmp slt i32 %m, %maxn$4
...
whileBody_87:                                        ; pred = %whileCond_87
  ...
  %ptr_ = getelementptr [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]], [18 x [18 x [18 x [18 x [18 x [7 x i32]]]]]]* @gv2, i32 0, i32 %i$1
...
whileBody_88:                                        ; pred = %whileCond_88
  ...
  %list = getelementptr [200 x i32], [200 x i32]* @gv3, i32 0, i32 %i$4
  %getint$1 = call i32 @getint()
  store i32 %getint$1, i32* %list, align 4
  %i$5 = load i32, i32* %lv$1, align 4
  %list$1 = getelementptr [200 x i32], [200 x i32]* @gv3, i32 0, i32 %i$5
  %list$2 = load i32, i32* %list$1, align 4
  %cns = getelementptr [20 x i32], [20 x i32]* @gv4, i32 0, i32 %list$2
  %i$6 = load i32, i32* %lv$1, align 4
  %list$3 = getelementptr [200 x i32], [200 x i32]* @gv3, i32 0, i32 %i$6
  %list$4 = load i32, i32* %list$3, align 4
  %cns$1 = getelementptr [20 x i32], [20 x i32]* @gv4, i32 0, i32 %list$4
...
next_169:                                            ; pred = %whileCond_88
  %cns$3 = getelementptr [20 x i32], [20 x i32]* @gv4, i32 0, i32 1
  %cns$4 = load i32, i32* %cns$3, align 4
  %cns$5 = getelementptr [20 x i32], [20 x i32]* @gv4, i32 0, i32 2
  %cns$6 = load i32, i32* %cns$5, align 4
  %cns$7 = getelementptr [20 x i32], [20 x i32]* @gv4, i32 0, i32 3
  %cns$8 = load i32, i32* %cns$7, align 4
  %cns$9 = getelementptr [20 x i32], [20 x i32]* @gv4, i32 0, i32 4
  %cns$10 = load i32, i32* %cns$9, align 4
  %cns$11 = getelementptr [20 x i32], [20 x i32]* @gv4, i32 0, i32 5
