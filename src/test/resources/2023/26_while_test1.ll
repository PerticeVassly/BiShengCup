...
whileCond_227:                                           ; pred = %doubleWhileEntry, %next_563
  %i = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, 100
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_227, label %next_562
...
next_562:                                                ; pred = %whileCond_227
  %j$3 = load i32, i32* %lv$1, align 4
  ret i32 %j$3

whileCond_228:                                           ; pred = %whileBody_227, %whileBody_228
  %j = load i32, i32* %lv$1, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %j, 100
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_228, label %next_563
