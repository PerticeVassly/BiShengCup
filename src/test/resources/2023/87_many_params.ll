...
whileCond_89:                                        ; pred = %sortEntry, %next_171
  ...
  br i1 %cond_, label %whileBody_89, label %next_170
...
whileCond_90:                                        ; pred = %whileBody_89, %next_172
  %j = load i32, i32* %lv$1, align 4
  %len$2 = load i32, i32* %len, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %j, %len$2
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_90, label %next_171
...
ifTrue_81:                                           ; pred = %whileBody_90
  ...
  %arr$8 = getelementptr i32, i32* %arr_$4, i32 %j$2
  ...
  %arr$10 = getelementptr i32, i32* %arr_$5, i32 %j$3
  %temp = load i32, i32* %lv$2, align 4
  store i32 %temp, i32* %arr$10, align 4
  br label %next_172

next_172:                                            ; pred = %whileBody_90, %ifTrue_81
...
param32_arrEntry:
  ...
  store i32 %result_$62, i32* %lv, align 4
  %sum$31 = load i32, i32* %lv, align 4
  ret i32 %sum$31
}
...
param16Entry:
  ...
  store i32 %a1$1, i32* %inp, align 4
  %inp$1 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 1
  store i32 %a2$1, i32* %inp$1, align 4
  %inp$2 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 2
  store i32 %a3$1, i32* %inp$2, align 4
  %inp$3 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 3
  store i32 %a4$1, i32* %inp$3, align 4
  %inp$4 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 4
  store i32 %a5$1, i32* %inp$4, align 4
  %inp$5 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 5
  store i32 %a6$1, i32* %inp$5, align 4
  %inp$6 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 6
  store i32 %a7$1, i32* %inp$6, align 4
  %inp$7 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 7
  store i32 %a8$1, i32* %inp$7, align 4
  %inp$8 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 8
  store i32 %a9$1, i32* %inp$8, align 4
  %inp$9 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 9
  store i32 %a10$1, i32* %inp$9, align 4
  %inp$10 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 10
  store i32 %a11$1, i32* %inp$10, align 4
  %inp$11 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 11
  store i32 %a12$1, i32* %inp$11, align 4
  %inp$12 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 12
  store i32 %a13$1, i32* %inp$12, align 4
  %inp$13 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 13
  store i32 %a14$1, i32* %inp$13, align 4
  %inp$14 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 14
  store i32 %a15$1, i32* %inp$14, align 4
  %inp$15 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 15
  store i32 %a16$1, i32* %inp$15, align 4
  %arr = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 0
  call void @sort(i32* %arr, i32 16)
  %arr$1 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 0
  %arr$2 = load i32, i32* %arr$1, align 4
  %arr$3 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 1
  %arr$4 = load i32, i32* %arr$3, align 4
  %arr$5 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 2
  %arr$6 = load i32, i32* %arr$5, align 4
  %arr$7 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 3
  %arr$8 = load i32, i32* %arr$7, align 4
  %arr$9 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 4
  %arr$10 = load i32, i32* %arr$9, align 4
  %arr$11 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 5
  %arr$12 = load i32, i32* %arr$11, align 4
  %arr$13 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 6
  %arr$14 = load i32, i32* %arr$13, align 4
  %arr$15 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 7
  %arr$16 = load i32, i32* %arr$15, align 4
  %arr$17 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 8
  %arr$18 = load i32, i32* %arr$17, align 4
  %arr$19 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 9
  %arr$20 = load i32, i32* %arr$19, align 4
  %arr$21 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 10
  %arr$22 = load i32, i32* %arr$21, align 4
  %arr$23 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 11
  %arr$24 = load i32, i32* %arr$23, align 4
  %arr$25 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 12
  %arr$26 = load i32, i32* %arr$25, align 4
  %arr$27 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 13
  %arr$28 = load i32, i32* %arr$27, align 4
  %arr$29 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 14
  %arr$30 = load i32, i32* %arr$29, align 4
  %arr$31 = getelementptr [16 x i32], [16 x i32]* %lv, i32 0, i32 15
  ...
  %param32_rec = call i32 @param32_rec(i32 %arr$2, i32 %arr$4, i32 %arr$6, i32 %arr$8, i32 %arr$10, i32 %arr$12, i32 %arr$14, i32 %arr$16, i32 %arr$18, i32 %arr$20, i32 %arr$22, i32 %arr$24, i32 %arr$26, i32 %arr$28, i32 %arr$30, i32 %arr$32, i32 %a1$2, i32 %a2$2, i32 %a3$2, i32 %a4$2, i32 %a5$2, i32 %a6$2, i32 %a7$2, i32 %a8$2, i32 %a9$2, i32 %a10$2, i32 %a11$2, i32 %a12$2, i32 %a13$2, i32 %a14$2, i32 %a15$2, i32 %a16$2)
  ret i32 %param32_rec
}
