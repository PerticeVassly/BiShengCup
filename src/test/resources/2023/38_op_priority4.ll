...
mainEntry40:
  ...
  br i1 %cond_, label %ifTrue_255, label %secondCond_94

ifTrue_255:                                           ; pred = %mainEntry40, %secondCond_94, %secondCond_93
  store i32 1, i32* %lv, align 4
  br label %next_437

next_437:                                             ; pred = %secondCond_93, %ifTrue_255
...
secondCond_93:                                        ; pred = %secondCond_94
  ...
  br i1 %cond_$2, label %ifTrue_255, label %next_437
...
secondCond_94:                                        ; pred = %mainEntry40
  ...
  br i1 %cond_$1, label %ifTrue_255, label %secondCond_93
}
