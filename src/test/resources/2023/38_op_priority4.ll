...
mainEntry40:
  ...
  %m109 = add i32 %getint$4, %getint$3
  ...
  br i1 %cond_neq_tmp_, label %ifTrue_257, label %secondCond_94

ifTrue_257:                                           ; pred = %mainEntry40, %secondCond_93, %secondCond_94
  store i32 1, i32* %lv, align 4
  br label %next_442

next_442:                                             ; pred = %ifTrue_257, %mid_150
...
secondCond_93:                                        ; pred = %secondCond_94
  ...
  %cond_eq_tmp_$1 = icmp eq i32 %result_$8, %m109
  br i1 %cond_eq_tmp_$1, label %ifTrue_257, label %mid_150

secondCond_94:                                        ; pred = %mainEntry40
  %result_$4 = mul i32 %getint, %getint$1
  %result_$5 = sdiv i32 %result_$4, %getint$2
  %cond_eq_tmp_ = icmp eq i32 %result_$5, %m109
  br i1 %cond_eq_tmp_, label %ifTrue_257, label %secondCond_93

mid_150:                                              ; pred = %secondCond_93
