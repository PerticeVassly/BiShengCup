...
mainEntry96:
  ...
  store i32 %getint$2, i32* @gv2, align 4
  ...
  br i1 %cond_, label %ifTrue_355, label %secondCond_130

ifTrue_355:                                            ; pred = %mainEntry96, %secondCond_130, %secondCond_129
  store i32 1, i32* %lv, align 4
  br label %next_611

next_611:                                              ; pred = %secondCond_129, %ifTrue_355
  %flag = load i32, i32* %lv, align 4
  ret i32 %flag

secondCond_129:                                        ; pred = %secondCond_130
  ...
  br i1 %cond_$2, label %ifTrue_355, label %next_611

secondCond_130:                                        ; pred = %mainEntry96
  ...
  br i1 %cond_$1, label %ifTrue_355, label %secondCond_129
}
