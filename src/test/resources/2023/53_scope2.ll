...
mainEntry78:
  ...
  br i1 %cond_, label %ifTrue_323, label %next_579

ifTrue_323:                                           ; pred = %mainEntry78
...
next_579:                                             ; pred = %mainEntry78, %next_580
  %k$8 = load i32, i32* @gv, align 4
  ret i32 %k$8

whileCond_256:                                        ; pred = %ifTrue_323, %next_581
  %k$2 = load i32, i32* %lv, align 4
  %cond_gt_tmp_ = icmp sgt i32 %k$2, 10
  %cond_tmp_$1 = zext i1 %cond_gt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_256, label %next_580
...
whileBody_256:                                        ; pred = %whileCond_256
  ...
  br i1 %cond_$2, label %ifTrue_324, label %next_581

next_580:                                             ; pred = %whileCond_256
  %k$7 = load i32, i32* %lv, align 4
  call void @putint(i32 %k$7)
  br label %next_579

ifTrue_324:                                           ; pred = %whileBody_256
...
next_581:                                             ; pred = %whileBody_256, %ifTrue_324
  br label %whileCond_256
}
