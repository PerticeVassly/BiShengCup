...
mainEntry29:
  ...
  br i1 %cond_, label %ifTrue_47, label %next_112

ifTrue_47:                                           ; pred = %mainEntry29
...
next_112:                                            ; pred = %mainEntry29, %next_113
  %k$9 = load i32, i32* @k, align 4
  ret i32 %k$9

whileCond_65:                                        ; pred = %ifTrue_47, %next_114
  %k$3 = load i32, i32* %k$2, align 4
  %cond_gt_tmp_ = icmp sgt i32 %k$3, 10
  %cond_tmp_$1 = zext i1 %cond_gt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_65, label %next_113
...
whileBody_65:                                        ; pred = %whileCond_65
  ...
  br i1 %cond_$2, label %ifTrue_48, label %next_114

next_113:                                            ; pred = %whileCond_65
  %k$8 = load i32, i32* %k$2, align 4
  call void @putint(i32 %k$8)
  br label %next_112

ifTrue_48:                                           ; pred = %whileBody_65
...
next_114:                                            ; pred = %whileBody_65, %ifTrue_48
  br label %whileCond_65
}
