...
whileCond_270:                                        ; pred = %initEntry, %whileBody_270
  ...
  br i1 %cond_, label %whileBody_270, label %next_592
...
findfaEntry:
  ...
  %array = getelementptr [110 x i32], [110 x i32]* @gv, i32 0, i32 %a$1
  %array$1 = load i32, i32* %array, align 4
  %a$2 = load i32, i32* %a, align 4
  %cond_eq_tmp_ = icmp eq i32 %array$1, %a$2
  %cond_tmp_ = zext i1 %cond_eq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_322, label %ifFalse_141

ifTrue_322:                                         ; pred = %findfaEntry
  %a$3 = load i32, i32* %a, align 4
  ret i32 %a$3

ifFalse_141:                                        ; pred = %findfaEntry
  %a$4 = load i32, i32* %a, align 4
  %array$2 = getelementptr [110 x i32], [110 x i32]* @gv, i32 0, i32 %a$4
  %a$5 = load i32, i32* %a, align 4
  %array$3 = getelementptr [110 x i32], [110 x i32]* @gv, i32 0, i32 %a$5
  ...
  %array$5 = getelementptr [110 x i32], [110 x i32]* @gv, i32 0, i32 %a$6
...
mmergeEntry:
  ...
  store i32 %findfa, i32* %lv, align 4
  %b$1 = load i32, i32* %b, align 4
  %findfa$1 = call i32 @findfa(i32 %b$1)
  store i32 %findfa$1, i32* %lv$1, align 4
  %m = load i32, i32* %lv, align 4
  %n = load i32, i32* %lv$1, align 4
  %cond_neq_tmp_ = icmp ne i32 %m, %n
  %cond_tmp_ = zext i1 %cond_neq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_323, label %next_594

ifTrue_323:                                         ; pred = %mmergeEntry
...
next_594:                                           ; pred = %mmergeEntry, %ifTrue_323
  ret void
}
...
whileCond_271:                                         ; pred = %mainEntry84, %next_605
  %t = load i32, i32* %lv, align 4
  %cond_normalize_ = icmp ne i32 %t, 0
  br i1 %cond_normalize_, label %whileBody_271, label %next_595
...
next_595:                                              ; pred = %whileCond_271
  ret i32 0

whileCond_272:                                         ; pred = %whileBody_271, %next_597
  %i = load i32, i32* %lv$4, align 4
  %m = load i32, i32* %lv$1, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, %m
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_272, label %next_596
...
whileBody_272:                                         ; pred = %whileCond_272
  ...
  br i1 %cond_normalize_$1, label %ifTrue_324, label %next_597

next_596:                                              ; pred = %whileCond_272
  ...
  br i1 %cond_normalize_$2, label %ifTrue_332, label %next_605

ifTrue_324:                                            ; pred = %whileBody_272
  ...
  br i1 %cond_$1, label %ifTrue_325, label %next_598

next_597:                                              ; pred = %whileBody_272, %next_604
  %i$2 = load i32, i32* %lv$4, align 4
  %result_$15 = add i32 %i$2, 1
  store i32 %result_$15, i32* %lv$4, align 4
  br label %whileCond_272

ifTrue_325:                                            ; pred = %ifTrue_324
...
next_598:                                              ; pred = %ifTrue_324, %ifTrue_325
  ...
  br i1 %cond_$2, label %ifTrue_326, label %next_599

ifTrue_326:                                            ; pred = %next_598
...
next_599:                                              ; pred = %next_598, %ifTrue_326
  ...
  br i1 %cond_$3, label %secondCond_112, label %next_600

ifTrue_327:                                            ; pred = %secondCond_112
...
next_600:                                              ; pred = %next_599, %secondCond_112, %ifTrue_327
  %b$2 = load i32, i32* %lv$3, align 4
  %cond_gt_tmp_ = icmp sgt i32 %b$2, 1
  %cond_tmp_$5 = zext i1 %cond_gt_tmp_ to i32
  %cond_$5 = icmp ne i32 %cond_tmp_$5, 0
  br i1 %cond_$5, label %secondCond_113, label %next_601

secondCond_112:                                        ; pred = %next_599
  ...
  br i1 %cond_$4, label %ifTrue_327, label %next_600

ifTrue_328:                                            ; pred = %secondCond_113
...
next_601:                                              ; pred = %next_600, %secondCond_113, %ifTrue_328
  ...
  br i1 %cond_$7, label %secondCond_114, label %next_602

secondCond_113:                                        ; pred = %next_600
  ...
  br i1 %cond_$6, label %ifTrue_328, label %next_601

ifTrue_329:                                            ; pred = %secondCond_114
...
next_602:                                              ; pred = %next_601, %secondCond_114, %ifTrue_329
  ...
  br i1 %cond_$9, label %secondCond_115, label %next_603

secondCond_114:                                        ; pred = %next_601
  ...
  br i1 %cond_$8, label %ifTrue_329, label %next_602

ifTrue_330:                                            ; pred = %secondCond_115
...
next_603:                                              ; pred = %next_602, %secondCond_115, %ifTrue_330
  ...
  br i1 %cond_$11, label %secondCond_117, label %next_604

secondCond_115:                                        ; pred = %next_602
  ...
  br i1 %cond_$10, label %ifTrue_330, label %next_603

ifTrue_331:                                            ; pred = %secondCond_116
...
next_604:                                              ; pred = %next_603, %secondCond_117, %secondCond_116, %ifTrue_331
  br label %next_597
...
secondCond_116:                                        ; pred = %secondCond_117
  ...
  br i1 %cond_$13, label %ifTrue_331, label %next_604
...
secondCond_117:                                        ; pred = %next_603
  ...
  br i1 %cond_$12, label %secondCond_116, label %next_604

ifTrue_332:                                            ; pred = %next_596
  call void @putint(i32 -1)
  call void @putch(i32 10)
  br label %next_605

next_605:                                              ; pred = %next_596, %ifTrue_332
  br label %whileCond_271
}
