...
whileCond_268:                                        ; pred = %initEntry, %whileBody_268
  ...
  br i1 %cond_, label %whileBody_268, label %next_596
...
findfaEntry:
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_328, label %ifFalse_143

ifTrue_328:                                         ; pred = %findfaEntry
  %a$2 = load i32, i32* %lv, align 4
  ret i32 %a$2

ifFalse_143:                                        ; pred = %findfaEntry
...
mmergeEntry:
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_329, label %next_598

ifTrue_329:                                         ; pred = %mmergeEntry
...
next_598:                                           ; pred = %mmergeEntry, %ifTrue_329
  ret void
}
...
whileCond_269:                                         ; pred = %mainEntry86, %next_609
  %t = load i32, i32* %lv, align 4
  %cond_normalize_ = icmp ne i32 %t, 0
  br i1 %cond_normalize_, label %whileBody_269, label %next_599
...
whileBody_270:                                         ; pred = %whileCond_270
  ...
  br i1 %cond_normalize_$1, label %ifTrue_330, label %next_601
...
next_600:                                              ; pred = %whileCond_270
  ...
  br i1 %cond_normalize_$2, label %ifTrue_338, label %next_609

ifTrue_330:                                            ; pred = %whileBody_270
  ...
  br i1 %cond_$1, label %ifTrue_331, label %next_602

next_601:                                              ; pred = %whileBody_270, %next_608
  %i$2 = load i32, i32* %lv$4, align 4
  %result_$15 = add i32 %i$2, 1
  store i32 %result_$15, i32* %lv$4, align 4
  br label %whileCond_270

ifTrue_331:                                            ; pred = %ifTrue_330
...
next_602:                                              ; pred = %ifTrue_330, %ifTrue_331
  ...
  br i1 %cond_$2, label %ifTrue_332, label %next_603

ifTrue_332:                                            ; pred = %next_602
...
next_603:                                              ; pred = %next_602, %ifTrue_332
  ...
  br i1 %cond_$3, label %secondCond_114, label %next_604

ifTrue_333:                                            ; pred = %secondCond_114
...
next_604:                                              ; pred = %next_603, %secondCond_114, %ifTrue_333
  %b$2 = load i32, i32* %lv$3, align 4
  %cond_gt_tmp_ = icmp sgt i32 %b$2, 1
  %cond_tmp_$5 = zext i1 %cond_gt_tmp_ to i32
  %cond_$5 = icmp ne i32 %cond_tmp_$5, 0
  br i1 %cond_$5, label %secondCond_115, label %next_605

secondCond_114:                                        ; pred = %next_603
  ...
  br i1 %cond_$4, label %ifTrue_333, label %next_604

ifTrue_334:                                            ; pred = %secondCond_115
...
next_605:                                              ; pred = %next_604, %secondCond_115, %ifTrue_334
  ...
  br i1 %cond_$7, label %secondCond_116, label %next_606

secondCond_115:                                        ; pred = %next_604
  ...
  br i1 %cond_$6, label %ifTrue_334, label %next_605

ifTrue_335:                                            ; pred = %secondCond_116
...
next_606:                                              ; pred = %next_605, %secondCond_116, %ifTrue_335
  ...
  br i1 %cond_$9, label %secondCond_117, label %next_607

secondCond_116:                                        ; pred = %next_605
  ...
  br i1 %cond_$8, label %ifTrue_335, label %next_606

ifTrue_336:                                            ; pred = %secondCond_117
...
next_607:                                              ; pred = %next_606, %secondCond_117, %ifTrue_336
  ...
  br i1 %cond_$11, label %secondCond_119, label %next_608

secondCond_117:                                        ; pred = %next_606
  ...
  br i1 %cond_$10, label %ifTrue_336, label %next_607

ifTrue_337:                                            ; pred = %secondCond_118
...
next_608:                                              ; pred = %next_607, %secondCond_119, %secondCond_118, %ifTrue_337
  br label %next_601
...
secondCond_118:                                        ; pred = %secondCond_119
  ...
  br i1 %cond_$13, label %ifTrue_337, label %next_608

secondCond_119:                                        ; pred = %next_607
  ...
  br i1 %cond_$12, label %secondCond_118, label %next_608

ifTrue_338:                                            ; pred = %next_600
  call void @putint(i32 -1)
  call void @putch(i32 10)
  br label %next_609

next_609:                                              ; pred = %next_600, %ifTrue_338
  br label %whileCond_269
}
