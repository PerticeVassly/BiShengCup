...
mainEntry4:
	...
	# get address of lv$1i42 points to
	li t2, 4220
	add t2, sp, t2
	sw t1, 0(t2)
...
whileCond_12:
	...
	# load ld_phi gv_to_lv

	# get address of gv_to_lv points to
	li t2, 4228
	add t2, sp, t2
	lw t0, 0(t2)
...
i89:
	...
	# mul result_i89 ld_phi$14 ints$1i94
...
i43:
	...
	# cmp cond_neq_tmp_i43 ld_phi$16 
...
i46:
	...
	# cmp cond_neq_tmp_$1i46 ld_phi$25 
