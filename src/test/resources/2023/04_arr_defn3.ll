...
mainEntry96:
  ...
  %ptr_$1 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$1, i32 0, i32 0
  ...
  %ptr_$3 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$1, i32 0, i32 1
  ...
  %ptr_$5 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$1, i32 0, i32 2
  ...
  %ptr_$7 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$1, i32 0, i32 3
  ...
  %ptr_$24 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$3, i32 0, i32 2
  %d = getelementptr [2 x i32], [2 x i32]* %ptr_$24, i32 0, i32 1
  %d$1 = load i32, i32* %d, align 4
  %ptr_$25 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$2, i32 0, i32 2
  %c = getelementptr [2 x i32], [2 x i32]* %ptr_$25, i32 0, i32 1
  ...
  %ptr_$27 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 0
  %inp$25 = getelementptr [2 x i32], [2 x i32]* %ptr_$27, i32 0, i32 1
  ...
  %ptr_$29 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 1
  %inp$27 = getelementptr [2 x i32], [2 x i32]* %ptr_$29, i32 0, i32 1
  ...
  %ptr_$31 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 2
  %inp$29 = getelementptr [2 x i32], [2 x i32]* %ptr_$31, i32 0, i32 1
  ...
  %ptr_$33 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 3
  %inp$31 = getelementptr [2 x i32], [2 x i32]* %ptr_$33, i32 0, i32 1
  store i32 8, i32* %inp$31, align 4
  %ptr_$34 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 3
  %e = getelementptr [2 x i32], [2 x i32]* %ptr_$34, i32 0, i32 1
  %e$1 = load i32, i32* %e, align 4
  %ptr_$35 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 0
  %e$2 = getelementptr [2 x i32], [2 x i32]* %ptr_$35, i32 0, i32 0
  %e$3 = load i32, i32* %e$2, align 4
  %result_ = add i32 %e$1, %e$3
  %ptr_$36 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 0
  %e$4 = getelementptr [2 x i32], [2 x i32]* %ptr_$36, i32 0, i32 1
