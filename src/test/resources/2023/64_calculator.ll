...
isdigitEntry:
  ...
  br i1 %cond_, label %secondCond_2, label %next_42

ifTrue_17:                                           ; pred = %secondCond_2
  ret i32 1

next_42:                                             ; pred = %isdigitEntry, %secondCond_2
  ret i32 0
...
secondCond_2:                                        ; pred = %isdigitEntry
  ...
  br i1 %cond_$1, label %ifTrue_17, label %next_42
}
...
whileCond_25:                                        ; pred = %powerEntry, %whileBody_25
  %a = load i32, i32* %lv$1, align 4
  %cond_neq_tmp_ = icmp ne i32 %a, 0
  %cond_tmp_ = zext i1 %cond_neq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_25, label %next_43
...
whileCond_26:                                        ; pred = %getstrEntry, %whileBody_26
  %x = load i32, i32* %lv$1, align 4
  %cond_neq_tmp_ = icmp ne i32 %x, 13
  %cond_tmp_ = zext i1 %cond_neq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %secondCond_3, label %next_44

whileBody_26:                                        ; pred = %secondCond_3
...
findEntry:
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_18, label %next_45

ifTrue_18:                                        ; pred = %findEntry
  ret i32 0

next_45:                                          ; pred = %findEntry
  ret i32 1
}
...
whileBody_27:                                         ; pred = %whileCond_27
  ...
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_19, label %ifFalse_3

next_46:                                              ; pred = %whileCond_27
  br label %whileCond_34

ifTrue_19:                                            ; pred = %whileBody_27
  %ii = load i32, i32* @gv5, align 4
  %get2 = getelementptr [10000 x i32], [10000 x i32]* @gv8, i32 0, i32 %ii
...
ifFalse_3:                                            ; pred = %whileBody_27
  ...
  br i1 %cond_$2, label %ifTrue_20, label %next_48

next_47:                                              ; pred = %ifTrue_19, %next_64
  %i$11 = load i32, i32* @gv4, align 4
  %result_$4 = add i32 %i$11, 1
  store i32 %result_$4, i32* @gv4, align 4
  br label %whileCond_27

ifTrue_20:                                            ; pred = %ifFalse_3
  call void @chapush(i32 40)
  br label %next_48

next_48:                                              ; pred = %ifFalse_3, %ifTrue_20
  ...
  br i1 %cond_$3, label %ifTrue_21, label %next_49

ifTrue_21:                                            ; pred = %next_48
  call void @chapush(i32 94)
  br label %next_49

next_49:                                              ; pred = %next_48, %ifTrue_21
  ...
  br i1 %cond_$4, label %ifTrue_22, label %next_50

ifTrue_22:                                            ; pred = %next_49
  %chapop = call i32 @chapop()
  store i32 %chapop, i32* @gv6, align 4
  br label %whileCond_28

next_50:                                              ; pred = %next_49, %next_51
  ...
  br i1 %cond_$6, label %ifTrue_23, label %next_52

whileCond_28:                                         ; pred = %ifTrue_22, %whileBody_28
  %c = load i32, i32* @gv6, align 4
  %cond_neq_tmp_ = icmp ne i32 %c, 40
  %cond_tmp_$5 = zext i1 %cond_neq_tmp_ to i32
  %cond_$5 = icmp ne i32 %cond_tmp_$5, 0
  br i1 %cond_$5, label %whileBody_28, label %next_51
...
ifTrue_23:                                            ; pred = %next_50
  br label %whileCond_29

next_52:                                              ; pred = %next_50, %next_53
  ...
  br i1 %cond_$14, label %ifTrue_25, label %next_55

whileCond_29:                                         ; pred = %ifTrue_23, %next_54
  %chat = load i32, i32* @gv3, align 4
  ...
  br i1 %cond_$7, label %whileBody_29, label %secondCond_8

whileBody_29:                                         ; pred = %whileCond_29, %secondCond_8, %secondCond_7, %secondCond_6, %secondCond_5, %secondCond_4
  %find = call i32 @find()
  %cond_eq_tmp_$11 = icmp eq i32 %find, 0
  %cond_tmp_$13 = zext i1 %cond_eq_tmp_$11 to i32
  %cond_$13 = icmp ne i32 %cond_tmp_$13, 0
  br i1 %cond_$13, label %ifTrue_24, label %next_54

next_53:                                              ; pred = %secondCond_4, %ifTrue_24
...
secondCond_5:                                         ; pred = %secondCond_6
  ...
  br i1 %cond_$11, label %whileBody_29, label %secondCond_4
...
secondCond_6:                                         ; pred = %secondCond_7
  ...
  br i1 %cond_$10, label %whileBody_29, label %secondCond_5
...
secondCond_7:                                         ; pred = %secondCond_8
  ...
  br i1 %cond_$9, label %whileBody_29, label %secondCond_6

secondCond_8:                                         ; pred = %whileCond_29
  %chat$1 = load i32, i32* @gv3, align 4
  ...
  br i1 %cond_$8, label %whileBody_29, label %secondCond_7

ifTrue_24:                                            ; pred = %whileBody_29
  br label %next_53
  br label %next_54

next_54:                                              ; pred = %whileBody_29, %ifTrue_24
  br label %whileCond_29

ifTrue_25:                                            ; pred = %next_52
  br label %whileCond_30

next_55:                                              ; pred = %next_52, %next_56
  ...
  br i1 %cond_$22, label %ifTrue_27, label %next_58

whileCond_30:                                         ; pred = %ifTrue_25, %next_57
  ...
  br i1 %cond_$15, label %whileBody_30, label %secondCond_13

whileBody_30:                                         ; pred = %whileCond_30, %secondCond_13, %secondCond_12, %secondCond_11, %secondCond_10, %secondCond_9
  ...
  br i1 %cond_$21, label %ifTrue_26, label %next_57

next_56:                                              ; pred = %secondCond_9, %ifTrue_26
...
secondCond_9:                                         ; pred = %secondCond_10
  ...
  br i1 %cond_$20, label %whileBody_30, label %next_56
...
secondCond_10:                                        ; pred = %secondCond_11
  ...
  br i1 %cond_$19, label %whileBody_30, label %secondCond_9
...
secondCond_11:                                        ; pred = %secondCond_12
  ...
  br i1 %cond_$18, label %whileBody_30, label %secondCond_10
...
secondCond_12:                                        ; pred = %secondCond_13
  ...
  br i1 %cond_$17, label %whileBody_30, label %secondCond_11

secondCond_13:                                        ; pred = %whileCond_30
  ...
  br i1 %cond_$16, label %whileBody_30, label %secondCond_12

ifTrue_26:                                            ; pred = %whileBody_30
  br label %next_56
  br label %next_57

next_57:                                              ; pred = %whileBody_30, %ifTrue_26
  br label %whileCond_30

ifTrue_27:                                            ; pred = %next_55
  br label %whileCond_31

next_58:                                              ; pred = %next_55, %next_59
  ...
  br i1 %cond_$28, label %ifTrue_29, label %next_61

whileCond_31:                                         ; pred = %ifTrue_27, %next_60
  ...
  br i1 %cond_$23, label %whileBody_31, label %secondCond_16

whileBody_31:                                         ; pred = %whileCond_31, %secondCond_16, %secondCond_15, %secondCond_14
  ...
  br i1 %cond_$27, label %ifTrue_28, label %next_60

next_59:                                              ; pred = %secondCond_14, %ifTrue_28
...
secondCond_14:                                        ; pred = %secondCond_15
  ...
  br i1 %cond_$26, label %whileBody_31, label %next_59
...
secondCond_15:                                        ; pred = %secondCond_16
  ...
  br i1 %cond_$25, label %whileBody_31, label %secondCond_14

secondCond_16:                                        ; pred = %whileCond_31
  ...
  br i1 %cond_$24, label %whileBody_31, label %secondCond_15

ifTrue_28:                                            ; pred = %whileBody_31
  br label %next_59
  br label %next_60

next_60:                                              ; pred = %whileBody_31, %ifTrue_28
  br label %whileCond_31

ifTrue_29:                                            ; pred = %next_58
  br label %whileCond_32

next_61:                                              ; pred = %next_58, %next_62
  ...
  br i1 %cond_$34, label %ifTrue_31, label %next_64

whileCond_32:                                         ; pred = %ifTrue_29, %next_63
  ...
  br i1 %cond_$29, label %whileBody_32, label %secondCond_19

whileBody_32:                                         ; pred = %whileCond_32, %secondCond_19, %secondCond_18, %secondCond_17
  ...
  br i1 %cond_$33, label %ifTrue_30, label %next_63

next_62:                                              ; pred = %secondCond_17, %ifTrue_30
...
secondCond_17:                                        ; pred = %secondCond_18
  ...
  br i1 %cond_$32, label %whileBody_32, label %next_62
...
secondCond_18:                                        ; pred = %secondCond_19
  ...
  br i1 %cond_$31, label %whileBody_32, label %secondCond_17

secondCond_19:                                        ; pred = %whileCond_32
  ...
  br i1 %cond_$30, label %whileBody_32, label %secondCond_18

ifTrue_30:                                            ; pred = %whileBody_32
  br label %next_62
  br label %next_63

next_63:                                              ; pred = %whileBody_32, %ifTrue_30
  br label %whileCond_32

ifTrue_31:                                            ; pred = %next_61
  br label %whileCond_33

next_64:                                              ; pred = %next_61, %next_65
...
whileCond_33:                                         ; pred = %ifTrue_31, %next_66
  ...
  br i1 %cond_$35, label %whileBody_33, label %secondCond_22

whileBody_33:                                         ; pred = %whileCond_33, %secondCond_22, %secondCond_21, %secondCond_20
  ...
  br i1 %cond_$39, label %ifTrue_32, label %next_66

next_65:                                              ; pred = %secondCond_20, %ifTrue_32
...
secondCond_20:                                        ; pred = %secondCond_21
  ...
  br i1 %cond_$38, label %whileBody_33, label %next_65
...
secondCond_21:                                        ; pred = %secondCond_22
  ...
  br i1 %cond_$37, label %whileBody_33, label %secondCond_20

secondCond_22:                                        ; pred = %whileCond_33
  ...
  br i1 %cond_$36, label %whileBody_33, label %secondCond_21

ifTrue_32:                                            ; pred = %whileBody_33
  br label %next_65
  br label %next_66

next_66:                                              ; pred = %whileBody_33, %ifTrue_32
  br label %whileCond_33

whileCond_34:                                         ; pred = %next_46, %whileBody_34
  ...
  br i1 %cond_$40, label %whileBody_34, label %next_67
...
whileCond_35:                                         ; pred = %next_67, %next_69
  ...
  br i1 %cond_$41, label %whileBody_35, label %next_68
...
whileBody_35:                                         ; pred = %whileCond_35
  ...
  br i1 %cond_$42, label %ifTrue_33, label %secondCond_27

next_68:                                              ; pred = %whileCond_35
  %ints = getelementptr [10000 x i32], [10000 x i32]* @gv, i32 0, i32 1
  %ints$1 = load i32, i32* %ints, align 4
  call void @putint(i32 %ints$1)
  ret i32 0

ifTrue_33:                                            ; pred = %whileBody_35, %secondCond_27, %secondCond_26, %secondCond_25, %secondCond_24, %secondCond_23
  ...
  br i1 %cond_$48, label %ifTrue_34, label %next_70
...
ifFalse_4:                                            ; pred = %secondCond_23
  ...
  br i1 %cond_$54, label %ifTrue_40, label %next_76

next_69:                                              ; pred = %next_75, %next_76
...
secondCond_23:                                        ; pred = %secondCond_24
  ...
  br i1 %cond_$47, label %ifTrue_33, label %ifFalse_4
...
secondCond_24:                                        ; pred = %secondCond_25
  ...
  br i1 %cond_$46, label %ifTrue_33, label %secondCond_23
...
secondCond_25:                                        ; pred = %secondCond_26
  ...
  br i1 %cond_$45, label %ifTrue_33, label %secondCond_24
...
secondCond_26:                                        ; pred = %secondCond_27
  ...
  br i1 %cond_$44, label %ifTrue_33, label %secondCond_25

secondCond_27:                                        ; pred = %whileBody_35
  ...
  br i1 %cond_$43, label %ifTrue_33, label %secondCond_26

ifTrue_34:                                            ; pred = %ifTrue_33
...
next_70:                                              ; pred = %ifTrue_33, %ifTrue_34
  ...
  br i1 %cond_$49, label %ifTrue_35, label %next_71
...
next_71:                                              ; pred = %next_70, %ifTrue_35
  ...
  br i1 %cond_$50, label %ifTrue_36, label %next_72

ifTrue_36:                                            ; pred = %next_71
...
next_72:                                              ; pred = %next_71, %ifTrue_36
  ...
  br i1 %cond_$51, label %ifTrue_37, label %next_73

ifTrue_37:                                            ; pred = %next_72
...
next_73:                                              ; pred = %next_72, %ifTrue_37
  ...
  br i1 %cond_$52, label %ifTrue_38, label %next_74
...
next_74:                                              ; pred = %next_73, %ifTrue_38
  ...
  br i1 %cond_$53, label %ifTrue_39, label %next_75

ifTrue_39:                                            ; pred = %next_74
...
next_75:                                              ; pred = %next_74, %ifTrue_39
  %c$3 = load i32, i32* %lv$4, align 4
  call void @intpush(i32 %c$3)
  br label %next_69

ifTrue_40:                                            ; pred = %ifFalse_4
...
next_76:                                              ; pred = %ifFalse_4, %next_77
  br label %next_69

whileCond_36:                                         ; pred = %ifTrue_40, %whileBody_36
  ...
  br i1 %cond_$55, label %whileBody_36, label %next_77
