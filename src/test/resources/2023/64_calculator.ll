...
inline92:                                             ; pred = %ifTrue_28
  ...
  store i32 %result_$12, i32* %ints_of_inline92, align 4
...
inline78:                                             ; pred = %next_35
  ...
  store i32 47, i32* %chas_of_inline78, align 4
...
inline66:                                             ; pred = %next_29
  ...
  store i32 45, i32* %chas_of_inline66, align 4
...
inline91:                                             ; pred = %next_48
  ...
  store i32 %c$3, i32* %ints_of_inline91, align 4
...
truncated11:                                          ; pred = %inline57, %inline56
...
inline72:                                             ; pred = %next_32
  ...
  store i32 42, i32* %chas_of_inline72, align 4
...
inline44:                                             ; pred = %inline46
  ...
  %get_of_inline44 = getelementptr i32, i32* %get, i32 %length_of_inline44
...
inline93:                                             ; pred = %whileBody_21
  ...
  %result_$1_of_inline93 = add i32 %ints$5_of_inline93, %result_$15
...
inline89:                                             ; pred = %inline88
  ...
  %result__of_inline89 = mul i32 %result_of_inline89, %b$5
...
inline51:                                             ; pred = %ifTrue_8
  ...
  store i32 40, i32* %chas_of_inline51, align 4
  br label %truncated7
...
inline60:                                             ; pred = %next_26
  ...
  store i32 43, i32* %chas_of_inline60, align 4
...
inline84:                                             ; pred = %next_38
  ...
  store i32 37, i32* %chas_of_inline84, align 4
...
inline47:                                             ; pred = %whileBody_12
  %cond_ge_tmp__of_inline47 = icmp sge i32 %get$2, 48
...
inline52:                                             ; pred = %ifTrue_9
  ...
  store i32 94, i32* %chas_of_inline52, align 4
  br label %truncated8
...
inline50:                                             ; pred = %inline47
  %cond_le_tmp__of_inline50 = icmp sle i32 %get$2, 57
