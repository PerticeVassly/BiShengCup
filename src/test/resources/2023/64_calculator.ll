...
isdigitEntry:
  ...
  br i1 %cond_, label %secondCond_75, label %next_402

ifTrue_243:                                           ; pred = %secondCond_75
  ret i32 1

next_402:                                             ; pred = %isdigitEntry, %secondCond_75
  ret i32 0
...
secondCond_75:                                        ; pred = %isdigitEntry
  ...
  br i1 %cond_$1, label %ifTrue_243, label %next_402
}
...
whileCond_159:                                        ; pred = %powerEntry, %whileBody_159
  %a = load i32, i32* %lv$1, align 4
  %cond_neq_tmp_ = icmp ne i32 %a, 0
  %cond_tmp_ = zext i1 %cond_neq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_159, label %next_403
...
whileCond_160:                                        ; pred = %getstrEntry, %whileBody_160
  %x = load i32, i32* %lv$1, align 4
  %cond_neq_tmp_ = icmp ne i32 %x, 13
  %cond_tmp_ = zext i1 %cond_neq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %secondCond_76, label %next_404

whileBody_160:                                        ; pred = %secondCond_76
...
findEntry:
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_244, label %next_405

ifTrue_244:                                        ; pred = %findEntry
  ret i32 0

next_405:                                          ; pred = %findEntry
  ret i32 1
}
...
whileBody_161:                                         ; pred = %whileCond_161
  ...
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_245, label %ifFalse_99

next_406:                                              ; pred = %whileCond_161
  br label %whileCond_168

ifTrue_245:                                            ; pred = %whileBody_161
  %ii = load i32, i32* @gv5, align 4
  %get2 = getelementptr [10000 x i32], [10000 x i32]* @gv8, i32 0, i32 %ii
...
ifFalse_99:                                            ; pred = %whileBody_161
  ...
  br i1 %cond_$2, label %ifTrue_246, label %next_408

next_407:                                              ; pred = %ifTrue_245, %next_424
  %i$11 = load i32, i32* @gv4, align 4
  %result_$4 = add i32 %i$11, 1
  store i32 %result_$4, i32* @gv4, align 4
  br label %whileCond_161

ifTrue_246:                                            ; pred = %ifFalse_99
  call void @chapush(i32 40)
  br label %next_408

next_408:                                              ; pred = %ifFalse_99, %ifTrue_246
  ...
  br i1 %cond_$3, label %ifTrue_247, label %next_409

ifTrue_247:                                            ; pred = %next_408
  call void @chapush(i32 94)
  br label %next_409

next_409:                                              ; pred = %next_408, %ifTrue_247
  ...
  br i1 %cond_$4, label %ifTrue_248, label %next_410

ifTrue_248:                                            ; pred = %next_409
  %chapop = call i32 @chapop()
  store i32 %chapop, i32* @gv6, align 4
  br label %whileCond_162

next_410:                                              ; pred = %next_409, %next_411
  ...
  br i1 %cond_$6, label %ifTrue_249, label %next_412

whileCond_162:                                         ; pred = %ifTrue_248, %whileBody_162
  %c = load i32, i32* @gv6, align 4
  %cond_neq_tmp_ = icmp ne i32 %c, 40
  %cond_tmp_$5 = zext i1 %cond_neq_tmp_ to i32
  %cond_$5 = icmp ne i32 %cond_tmp_$5, 0
  br i1 %cond_$5, label %whileBody_162, label %next_411
...
next_411:                                              ; pred = %whileCond_162
  br label %next_410

ifTrue_249:                                            ; pred = %next_410
...
next_412:                                              ; pred = %next_410, %next_413
  ...
  br i1 %cond_$14, label %ifTrue_251, label %next_415

whileCond_163:                                         ; pred = %ifTrue_249, %next_414
  %chat = load i32, i32* @gv3, align 4
  ...
  br i1 %cond_$7, label %whileBody_163, label %secondCond_81

whileBody_163:                                         ; pred = %whileCond_163, %secondCond_81, %secondCond_80, %secondCond_79, %secondCond_78, %secondCond_77
  %find = call i32 @find()
  %cond_eq_tmp_$11 = icmp eq i32 %find, 0
  %cond_tmp_$13 = zext i1 %cond_eq_tmp_$11 to i32
  %cond_$13 = icmp ne i32 %cond_tmp_$13, 0
  br i1 %cond_$13, label %ifTrue_250, label %next_414

next_413:                                              ; pred = %secondCond_77, %ifTrue_250
...
secondCond_77:                                         ; pred = %secondCond_78
  ...
  br i1 %cond_$12, label %whileBody_163, label %next_413
...
secondCond_78:                                         ; pred = %secondCond_79
  ...
  br i1 %cond_$11, label %whileBody_163, label %secondCond_77
...
secondCond_79:                                         ; pred = %secondCond_80
  ...
  br i1 %cond_$10, label %whileBody_163, label %secondCond_78
...
secondCond_80:                                         ; pred = %secondCond_81
  ...
  br i1 %cond_$9, label %whileBody_163, label %secondCond_79

secondCond_81:                                         ; pred = %whileCond_163
  %chat$1 = load i32, i32* @gv3, align 4
  ...
  br i1 %cond_$8, label %whileBody_163, label %secondCond_80

ifTrue_250:                                            ; pred = %whileBody_163
  br label %next_413
  br label %next_414

next_414:                                              ; pred = %whileBody_163, %ifTrue_250
  br label %whileCond_163

ifTrue_251:                                            ; pred = %next_412
...
next_415:                                              ; pred = %next_412, %next_416
  ...
  br i1 %cond_$22, label %ifTrue_253, label %next_418

whileCond_164:                                         ; pred = %ifTrue_251, %next_417
  ...
  br i1 %cond_$15, label %whileBody_164, label %secondCond_86

whileBody_164:                                         ; pred = %whileCond_164, %secondCond_86, %secondCond_85, %secondCond_84, %secondCond_83, %secondCond_82
  ...
  br i1 %cond_$21, label %ifTrue_252, label %next_417

next_416:                                              ; pred = %secondCond_82, %ifTrue_252
...
secondCond_82:                                         ; pred = %secondCond_83
  ...
  br i1 %cond_$20, label %whileBody_164, label %next_416
...
secondCond_83:                                         ; pred = %secondCond_84
  ...
  br i1 %cond_$19, label %whileBody_164, label %secondCond_82
...
secondCond_84:                                         ; pred = %secondCond_85
  ...
  br i1 %cond_$18, label %whileBody_164, label %secondCond_83
...
secondCond_85:                                         ; pred = %secondCond_86
  ...
  br i1 %cond_$17, label %whileBody_164, label %secondCond_84

secondCond_86:                                         ; pred = %whileCond_164
  ...
  br i1 %cond_$16, label %whileBody_164, label %secondCond_85

ifTrue_252:                                            ; pred = %whileBody_164
  br label %next_416
  br label %next_417

next_417:                                              ; pred = %whileBody_164, %ifTrue_252
  br label %whileCond_164

ifTrue_253:                                            ; pred = %next_415
...
next_418:                                              ; pred = %next_415, %next_419
  ...
  br i1 %cond_$28, label %ifTrue_255, label %next_421

whileCond_165:                                         ; pred = %ifTrue_253, %next_420
  ...
  br i1 %cond_$23, label %whileBody_165, label %secondCond_89

whileBody_165:                                         ; pred = %whileCond_165, %secondCond_89, %secondCond_88, %secondCond_87
  ...
  br i1 %cond_$27, label %ifTrue_254, label %next_420

next_419:                                              ; pred = %secondCond_87, %ifTrue_254
...
secondCond_87:                                         ; pred = %secondCond_88
  ...
  br i1 %cond_$26, label %whileBody_165, label %next_419
...
secondCond_88:                                         ; pred = %secondCond_89
  ...
  br i1 %cond_$25, label %whileBody_165, label %secondCond_87

secondCond_89:                                         ; pred = %whileCond_165
  ...
  br i1 %cond_$24, label %whileBody_165, label %secondCond_88

ifTrue_254:                                            ; pred = %whileBody_165
  br label %next_419
  br label %next_420

next_420:                                              ; pred = %whileBody_165, %ifTrue_254
  br label %whileCond_165

ifTrue_255:                                            ; pred = %next_418
  br label %whileCond_166

next_421:                                              ; pred = %next_418, %next_422
  ...
  br i1 %cond_$34, label %ifTrue_257, label %next_424

whileCond_166:                                         ; pred = %ifTrue_255, %next_423
  ...
  br i1 %cond_$29, label %whileBody_166, label %secondCond_92

whileBody_166:                                         ; pred = %whileCond_166, %secondCond_92, %secondCond_91, %secondCond_90
  ...
  br i1 %cond_$33, label %ifTrue_256, label %next_423

next_422:                                              ; pred = %secondCond_90, %ifTrue_256
...
secondCond_90:                                         ; pred = %secondCond_91
  ...
  br i1 %cond_$32, label %whileBody_166, label %next_422
...
secondCond_91:                                         ; pred = %secondCond_92
  ...
  br i1 %cond_$31, label %whileBody_166, label %secondCond_90

secondCond_92:                                         ; pred = %whileCond_166
  ...
  br i1 %cond_$30, label %whileBody_166, label %secondCond_91

ifTrue_256:                                            ; pred = %whileBody_166
  br label %next_422
  br label %next_423

next_423:                                              ; pred = %whileBody_166, %ifTrue_256
  br label %whileCond_166

ifTrue_257:                                            ; pred = %next_421
  br label %whileCond_167

next_424:                                              ; pred = %next_421, %next_425
...
whileCond_167:                                         ; pred = %ifTrue_257, %next_426
  ...
  br i1 %cond_$35, label %whileBody_167, label %secondCond_95

whileBody_167:                                         ; pred = %whileCond_167, %secondCond_95, %secondCond_94, %secondCond_93
  ...
  br i1 %cond_$39, label %ifTrue_258, label %next_426

next_425:                                              ; pred = %secondCond_93, %ifTrue_258
...
secondCond_93:                                         ; pred = %secondCond_94
  ...
  br i1 %cond_$38, label %whileBody_167, label %next_425
...
secondCond_94:                                         ; pred = %secondCond_95
  ...
  br i1 %cond_$37, label %whileBody_167, label %secondCond_93

secondCond_95:                                         ; pred = %whileCond_167
  ...
  br i1 %cond_$36, label %whileBody_167, label %secondCond_94

ifTrue_258:                                            ; pred = %whileBody_167
  br label %next_425
  br label %next_426

next_426:                                              ; pred = %whileBody_167, %ifTrue_258
  br label %whileCond_167

whileCond_168:                                         ; pred = %next_406, %whileBody_168
  ...
  br i1 %cond_$40, label %whileBody_168, label %next_427
...
whileCond_169:                                         ; pred = %next_427, %next_429
  ...
  br i1 %cond_$41, label %whileBody_169, label %next_428
...
whileBody_169:                                         ; pred = %whileCond_169
  ...
  br i1 %cond_$42, label %ifTrue_259, label %secondCond_100

next_428:                                              ; pred = %whileCond_169
  %ints = getelementptr [10000 x i32], [10000 x i32]* @gv, i32 0, i32 1
  %ints$1 = load i32, i32* %ints, align 4
  call void @putint(i32 %ints$1)
  ret i32 0

ifTrue_259:                                            ; pred = %whileBody_169, %secondCond_100, %secondCond_99, %secondCond_98, %secondCond_97, %secondCond_96
  ...
  br i1 %cond_$48, label %ifTrue_260, label %next_430

ifFalse_100:                                           ; pred = %secondCond_96
  ...
  br i1 %cond_$54, label %ifTrue_266, label %next_436

next_429:                                              ; pred = %next_435, %next_436
...
secondCond_96:                                         ; pred = %secondCond_97
  ...
  br i1 %cond_$47, label %ifTrue_259, label %ifFalse_100
...
secondCond_97:                                         ; pred = %secondCond_98
  ...
  br i1 %cond_$46, label %ifTrue_259, label %secondCond_96
...
secondCond_98:                                         ; pred = %secondCond_99
  ...
  br i1 %cond_$45, label %ifTrue_259, label %secondCond_97
...
secondCond_99:                                         ; pred = %secondCond_100
  ...
  br i1 %cond_$44, label %ifTrue_259, label %secondCond_98

secondCond_100:                                        ; pred = %whileBody_169
  ...
  br i1 %cond_$43, label %ifTrue_259, label %secondCond_99
...
next_430:                                              ; pred = %ifTrue_259, %ifTrue_260
  ...
  br i1 %cond_$49, label %ifTrue_261, label %next_431

ifTrue_261:                                            ; pred = %next_430
...
next_431:                                              ; pred = %next_430, %ifTrue_261
  ...
  br i1 %cond_$50, label %ifTrue_262, label %next_432

ifTrue_262:                                            ; pred = %next_431
...
next_432:                                              ; pred = %next_431, %ifTrue_262
  ...
  br i1 %cond_$51, label %ifTrue_263, label %next_433

ifTrue_263:                                            ; pred = %next_432
...
next_433:                                              ; pred = %next_432, %ifTrue_263
  ...
  br i1 %cond_$52, label %ifTrue_264, label %next_434

ifTrue_264:                                            ; pred = %next_433
...
next_434:                                              ; pred = %next_433, %ifTrue_264
  ...
  br i1 %cond_$53, label %ifTrue_265, label %next_435

ifTrue_265:                                            ; pred = %next_434
...
next_435:                                              ; pred = %next_434, %ifTrue_265
  %c$3 = load i32, i32* %lv$4, align 4
  call void @intpush(i32 %c$3)
  br label %next_429

ifTrue_266:                                            ; pred = %ifFalse_100
...
next_436:                                              ; pred = %ifFalse_100, %next_437
  br label %next_429

whileCond_170:                                         ; pred = %ifTrue_266, %whileBody_170
  ...
  br i1 %cond_$55, label %whileBody_170, label %next_437
