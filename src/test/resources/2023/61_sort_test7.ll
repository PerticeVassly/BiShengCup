...
merge_sortEntry:
  ...
  br i1 %cond_, label %ifTrue_246, label %next_424

ifTrue_246:                                             ; pred = %merge_sortEntry
  ret void

next_424:                                               ; pred = %merge_sortEntry
...
whileCond_178:                                          ; pred = %next_424, %next_426
  %i$1 = load i32, i32* %i, align 4
  %mid$4 = load i32, i32* %mid, align 4
  %cond_lt_tmp_ = icmp slt i32 %i$1, %mid$4
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %secondCond_96, label %next_425

whileBody_178:                                          ; pred = %secondCond_96
  ...
  br i1 %cond_$3, label %ifTrue_247, label %ifFalse_101

next_425:                                               ; pred = %whileCond_178, %secondCond_96
  br label %whileCond_179

secondCond_96:                                          ; pred = %whileCond_178
  ...
  br i1 %cond_$2, label %whileBody_178, label %next_425

ifTrue_247:                                             ; pred = %whileBody_178
...
ifFalse_101:                                            ; pred = %whileBody_178
...
whileCond_179:                                          ; pred = %next_425, %whileBody_179
  ...
  br i1 %cond_$4, label %whileBody_179, label %next_427
...
next_427:                                               ; pred = %whileCond_179
  br label %whileCond_180

whileCond_180:                                          ; pred = %next_427, %whileBody_180
  ...
  br i1 %cond_$5, label %whileBody_180, label %next_428
...
next_428:                                               ; pred = %whileCond_180
  br label %whileCond_181

whileCond_181:                                          ; pred = %next_428, %whileBody_181
  ...
  br i1 %cond_$6, label %whileBody_181, label %next_429
