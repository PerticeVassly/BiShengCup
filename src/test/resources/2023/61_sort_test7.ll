...
secondCond_96:                                          ; pred = %whileCond_195
  ...
  %cond_lt_tmp_$1 = icmp slt i32 %j, %r$4
...
whileCond_197:                                          ; pred = %next_460, %whileBody_197
  ...
  %cond_lt_tmp_$4 = icmp slt i32 %j$4, %r$5
