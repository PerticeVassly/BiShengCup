...
merge_sortEntry:
  ...
  br i1 %cond_, label %ifTrue_94, label %next_193

ifTrue_94:                                              ; pred = %merge_sortEntry
  ret void

next_193:                                               ; pred = %merge_sortEntry
...
whileCond_99:                                           ; pred = %next_193, %next_195
  ...
  br i1 %cond_$1, label %secondCond_53, label %next_194

whileBody_99:                                           ; pred = %secondCond_53
  ...
  br i1 %cond_$3, label %ifTrue_95, label %ifFalse_32

next_194:                                               ; pred = %whileCond_99, %secondCond_53
  br label %whileCond_100

secondCond_53:                                          ; pred = %whileCond_99
  ...
  br i1 %cond_$2, label %whileBody_99, label %next_194

ifTrue_95:                                              ; pred = %whileBody_99
...
whileCond_100:                                          ; pred = %next_194, %whileBody_100
  ...
  br i1 %cond_$4, label %whileBody_100, label %next_196
...
whileCond_101:                                          ; pred = %next_196, %whileBody_101
  ...
  br i1 %cond_$5, label %whileBody_101, label %next_197
...
whileCond_102:                                          ; pred = %next_197, %whileBody_102
  ...
  br i1 %cond_$6, label %whileBody_102, label %next_198
