...
ifElseIfEntry:
  ...
  br i1 %cond_, label %ifTrue_298, label %secondCond_119

ifTrue_298:                                            ; pred = %ifElseIfEntry, %secondCond_119
...
secondCond_119:                                        ; pred = %ifElseIfEntry
  ...
  br i1 %cond_$1, label %ifTrue_298, label %ifFalse_113

ifTrue_299:                                            ; pred = %secondCond_120
...
next_522:                                              ; pred = %ifTrue_299, %next_523
  br label %next_521
...
secondCond_120:                                        ; pred = %ifFalse_113
  ...
  br i1 %cond_$3, label %ifTrue_299, label %ifFalse_114

ifTrue_300:                                            ; pred = %secondCond_121
...
next_523:                                              ; pred = %ifTrue_300, %ifFalse_115
  br label %next_522
...
secondCond_121:                                        ; pred = %ifFalse_114
  ...
  br i1 %cond_$5, label %ifTrue_300, label %ifFalse_115
}
