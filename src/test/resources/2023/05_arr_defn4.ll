...
define i32 @main() {
mainEntry46:
  %lv$5 = alloca [4 x [2 x [1 x i32]]], align 16
  ...
  %ptr_$24 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv, i32 0, i32 3
  %a = getelementptr [2 x i32], [2 x i32]* %ptr_$24, i32 0, i32 0
  %a$1 = load i32, i32* %a, align 4
  %ptr_$25 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 0
  %inp$24 = getelementptr [2 x i32], [2 x i32]* %ptr_$25, i32 0, i32 0
  ...
  %ptr_$27 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 1
  %inp$26 = getelementptr [2 x i32], [2 x i32]* %ptr_$27, i32 0, i32 0
  ...
  %ptr_$29 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 2
  %inp$28 = getelementptr [2 x i32], [2 x i32]* %ptr_$29, i32 0, i32 0
  ...
  %ptr_$31 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 3
  %inp$30 = getelementptr [2 x i32], [2 x i32]* %ptr_$31, i32 0, i32 0
  store i32 %a$1, i32* %inp$30, align 4
  ...
  %ptr_$33 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 2
  %d = getelementptr [2 x i32], [2 x i32]* %ptr_$33, i32 0, i32 1
  %d$1 = load i32, i32* %d, align 4
  %ptr_$34 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$3, i32 0, i32 2
  %c = getelementptr [2 x i32], [2 x i32]* %ptr_$34, i32 0, i32 1
  %c$1 = load i32, i32* %c, align 4
  %ptr_$35 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 0
  %ptr_$36 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$35, i32 0, i32 0
  %inp$32 = getelementptr [1 x i32], [1 x i32]* %ptr_$36, i32 0, i32 0
  store i32 %d$1, i32* %inp$32, align 4
  %ptr_$37 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 0
  %ptr_$38 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$37, i32 0, i32 1
  %inp$33 = getelementptr [1 x i32], [1 x i32]* %ptr_$38, i32 0, i32 0
  store i32 %c$1, i32* %inp$33, align 4
  %ptr_$39 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 1
  %ptr_$40 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$39, i32 0, i32 0
  %inp$34 = getelementptr [1 x i32], [1 x i32]* %ptr_$40, i32 0, i32 0
  store i32 3, i32* %inp$34, align 4
  %ptr_$41 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 1
  %ptr_$42 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$41, i32 0, i32 1
  %inp$35 = getelementptr [1 x i32], [1 x i32]* %ptr_$42, i32 0, i32 0
  store i32 4, i32* %inp$35, align 4
  %ptr_$43 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 2
  %ptr_$44 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$43, i32 0, i32 0
  %inp$36 = getelementptr [1 x i32], [1 x i32]* %ptr_$44, i32 0, i32 0
  store i32 5, i32* %inp$36, align 4
  %ptr_$45 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 2
  %ptr_$46 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$45, i32 0, i32 1
  %inp$37 = getelementptr [1 x i32], [1 x i32]* %ptr_$46, i32 0, i32 0
  store i32 6, i32* %inp$37, align 4
  %ptr_$47 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 3
  %ptr_$48 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$47, i32 0, i32 0
  %inp$38 = getelementptr [1 x i32], [1 x i32]* %ptr_$48, i32 0, i32 0
  store i32 7, i32* %inp$38, align 4
  %ptr_$49 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 3
  %ptr_$50 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$49, i32 0, i32 1
  %inp$39 = getelementptr [1 x i32], [1 x i32]* %ptr_$50, i32 0, i32 0
  store i32 8, i32* %inp$39, align 4
  %ptr_$51 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 3
  %ptr_$52 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$51, i32 0, i32 1
  %e = getelementptr [1 x i32], [1 x i32]* %ptr_$52, i32 0, i32 0
  %e$1 = load i32, i32* %e, align 4
  %ptr_$53 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 0
  %ptr_$54 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$53, i32 0, i32 0
  %e$2 = getelementptr [1 x i32], [1 x i32]* %ptr_$54, i32 0, i32 0
  %e$3 = load i32, i32* %e$2, align 4
  %result_ = add i32 %e$1, %e$3
  %ptr_$55 = getelementptr [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %lv$5, i32 0, i32 0
  %ptr_$56 = getelementptr [2 x [1 x i32]], [2 x [1 x i32]]* %ptr_$55, i32 0, i32 1
  %e$4 = getelementptr [1 x i32], [1 x i32]* %ptr_$56, i32 0, i32 0
  %e$5 = load i32, i32* %e$4, align 4
  %result_$1 = add i32 %result_, %e$5
  %ptr_$57 = getelementptr [4 x [2 x i32]], [4 x [2 x i32]]* %lv$4, i32 0, i32 3
  %d$2 = getelementptr [2 x i32], [2 x i32]* %ptr_$57, i32 0, i32 0
