...
ifTrue_280:                                           ; pred = %secondCond_98
  ...
  %ans = getelementptr [50 x i32], [50 x i32]* @gv, i32 0, i32 %step$3
...
whileCond_207:                                        ; pred = %mainEntry55, %whileBody_207
