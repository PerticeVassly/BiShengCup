...
if_ifElse_Entry:
  ...
  br i1 %cond_, label %ifTrue_116, label %next_226

ifTrue_116:                                             ; pred = %if_ifElse_Entry
  %b = load i32, i32* %lv$1, align 4
  %cond_eq_tmp_$1 = icmp eq i32 %b, 10
  %cond_tmp_$1 = zext i1 %cond_eq_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_117, label %ifFalse_44

next_226:                                               ; pred = %if_ifElse_Entry, %next_227
...
ifFalse_44:                                             ; pred = %ifTrue_116
  %a$1 = load i32, i32* %lv, align 4
  %result_ = add i32 %a$1, 15
  store i32 %result_, i32* %lv, align 4
  br label %next_227

next_227:                                               ; pred = %ifTrue_117, %ifFalse_44
  br label %next_226
}
