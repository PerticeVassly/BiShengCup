...
whileCond_196:                                           ; pred = %insertsortEntry1, %next_490
  %i = load i32, i32* %lv$1, align 4
  %n = load i32, i32* @gv, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, %n
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_196, label %next_489
...
next_489:                                                ; pred = %whileCond_196
  ret i32 0

whileCond_197:                                           ; pred = %whileBody_196, %whileBody_197
  %j = load i32, i32* %lv$3, align 4
  %cond_gt_tmp_ = icmp sgt i32 %j, -1
  %cond_tmp_$1 = zext i1 %cond_gt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %secondCond_112, label %next_490

whileBody_197:                                           ; pred = %secondCond_112
...
next_490:                                                ; pred = %whileCond_197, %secondCond_112
...
secondCond_112:                                          ; pred = %whileCond_197
  ...
  br i1 %cond_$2, label %whileBody_197, label %next_490
}
...
whileCond_198:                                        ; pred = %mainEntry59, %whileBody_198
  %i = load i32, i32* %lv$1, align 4
  %n = load i32, i32* @gv, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, %n
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_198, label %next_491
