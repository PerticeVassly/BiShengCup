...
define i32 @main() {
mainEntry7:
  %lv_of_inline172 = alloca i32, align 4
...
inline173:                                           ; pred = %inline172, %inline174
  %a_of_inline173 = load i32, i32* %lv_of_inline172, align 4
  %cond_gt_tmp__of_inline173 = icmp sgt i32 %a_of_inline173, 0
...
inline172:                                           ; pred = %truncated34
  store i32 %m, i32* %lv_of_inline172, align 4
...
inline174:                                           ; pred = %inline173
  ...
  %a$1_of_inline174 = load i32, i32* %lv_of_inline172, align 4
  %result__of_inline174 = srem i32 %a$1_of_inline174, 10
  %result_$1_of_inline174 = add i32 %result__of_inline174, 48
  store i32 %result_$1_of_inline174, i32* %b_of_inline174, align 4
  %a$2_of_inline174 = load i32, i32* %lv_of_inline172, align 4
  %result_$2_of_inline174 = sdiv i32 %a$2_of_inline174, 10
  store i32 %result_$2_of_inline174, i32* %lv_of_inline172, align 4
