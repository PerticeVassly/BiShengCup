...
mainEntry28:
  ...
  br i1 %cond_normalize_, label %secondCond_57, label %next_344

ifTrue_203:                                           ; pred = %secondCond_57
  br label %next_344

next_344:                                             ; pred = %mainEntry28, %secondCond_57, %ifTrue_203
  %a = load i32, i32* @gv, align 4
  ...
  br i1 %cond_normalize_$2, label %secondCond_58, label %next_345

secondCond_57:                                        ; pred = %mainEntry28
  %set_b = call i32 @set_b(i32 1)
  %cond_normalize_$1 = icmp ne i32 %set_b, 0
  br i1 %cond_normalize_$1, label %ifTrue_203, label %next_344

ifTrue_204:                                           ; pred = %secondCond_58
  br label %next_345

next_345:                                             ; pred = %next_344, %secondCond_58, %ifTrue_204
  ...
  br i1 %cond_, label %secondCond_59, label %next_346

secondCond_58:                                        ; pred = %next_344
  %set_b$1 = call i32 @set_b(i32 1)
  %cond_normalize_$3 = icmp ne i32 %set_b$1, 0
  br i1 %cond_normalize_$3, label %ifTrue_204, label %next_345

ifTrue_205:                                           ; pred = %secondCond_59
  br label %next_346

next_346:                                             ; pred = %next_345, %secondCond_59, %ifTrue_205
  %d = load i32, i32* @gv2, align 4
  ...
  br i1 %cond_$1, label %ifTrue_206, label %secondCond_60

secondCond_59:                                        ; pred = %next_345
  %set_d = call i32 @set_d(i32 3)
  %cond_normalize_$4 = icmp ne i32 %set_d, 0
  br i1 %cond_normalize_$4, label %ifTrue_205, label %next_346

ifTrue_206:                                           ; pred = %next_346, %secondCond_60
  br label %next_347

next_347:                                             ; pred = %secondCond_60, %ifTrue_206
  ...
  br i1 %cond_$2, label %ifTrue_207, label %next_348

secondCond_60:                                        ; pred = %next_346
  %set_d$1 = call i32 @set_d(i32 4)
  %cond_normalize_$5 = icmp ne i32 %set_d$1, 0
  br i1 %cond_normalize_$5, label %ifTrue_206, label %next_347

ifTrue_207:                                           ; pred = %next_347
  call void @putch(i32 65)
  br label %next_348

next_348:                                             ; pred = %next_347, %ifTrue_207
  br i1 false, label %ifTrue_208, label %next_349

ifTrue_208:                                           ; pred = %next_348
  call void @putch(i32 66)
  br label %next_349

next_349:                                             ; pred = %next_348, %ifTrue_208
  ...
  br i1 %cond_$4, label %ifTrue_209, label %next_350

ifTrue_209:                                           ; pred = %next_349
  call void @putch(i32 67)
  br label %next_350

next_350:                                             ; pred = %next_349, %ifTrue_209
  ...
  br i1 %cond_$6, label %ifTrue_210, label %next_351

ifTrue_210:                                           ; pred = %next_350
  call void @putch(i32 68)
  br label %next_351

next_351:                                             ; pred = %next_350, %ifTrue_210
  ...
  br i1 %cond_$8, label %ifTrue_211, label %next_352

ifTrue_211:                                           ; pred = %next_351
  call void @putch(i32 69)
  br label %next_352

next_352:                                             ; pred = %next_351, %ifTrue_211
  br i1 true, label %ifTrue_212, label %next_353

ifTrue_212:                                           ; pred = %next_352
  call void @putch(i32 70)
  br label %next_353

next_353:                                             ; pred = %next_352, %ifTrue_212
  call void @putch(i32 10)
  store i32 0, i32* %lv, align 4
...
whileCond_141:                                        ; pred = %next_353, %whileBody_141
  %i0 = load i32, i32* %lv, align 4
  %cond_normalize_$6 = icmp ne i32 %i0, 0
  br i1 %cond_normalize_$6, label %secondCond_61, label %next_354

whileBody_141:                                        ; pred = %secondCond_61
  call void @putch(i32 32)
  br label %whileCond_141

next_354:                                             ; pred = %whileCond_141, %secondCond_61
  %i0$1 = load i32, i32* %lv, align 4
  %cond_normalize_$8 = icmp ne i32 %i0$1, 0
  br i1 %cond_normalize_$8, label %ifTrue_213, label %secondCond_62

secondCond_61:                                        ; pred = %whileCond_141
  %i1 = load i32, i32* %lv$1, align 4
  %cond_normalize_$7 = icmp ne i32 %i1, 0
  br i1 %cond_normalize_$7, label %whileBody_141, label %next_354

ifTrue_213:                                           ; pred = %next_354, %secondCond_62
  call void @putch(i32 67)
  br label %next_355

next_355:                                             ; pred = %secondCond_62, %ifTrue_213
  ...
  br i1 %cond_$9, label %ifTrue_214, label %secondCond_63

secondCond_62:                                        ; pred = %next_354
  %i1$1 = load i32, i32* %lv$1, align 4
  %cond_normalize_$9 = icmp ne i32 %i1$1, 0
  br i1 %cond_normalize_$9, label %ifTrue_213, label %next_355

ifTrue_214:                                           ; pred = %next_355, %secondCond_63
  call void @putch(i32 72)
  br label %next_356

next_356:                                             ; pred = %secondCond_63, %ifTrue_214
  ...
  br i1 %cond_$11, label %secondCond_64, label %next_357

secondCond_63:                                        ; pred = %next_355
  ...
  br i1 %cond_$10, label %ifTrue_214, label %next_356

ifTrue_215:                                           ; pred = %secondCond_64
  call void @putch(i32 73)
  br label %next_357

next_357:                                             ; pred = %next_356, %secondCond_64, %ifTrue_215
...
secondCond_64:                                        ; pred = %next_356
  ...
  br i1 %cond_$12, label %ifTrue_215, label %next_357

ifTrue_216:                                           ; pred = %secondCond_66, %secondCond_65
  call void @putch(i32 74)
  br label %next_358

next_358:                                             ; pred = %secondCond_65, %ifTrue_216
  ...
  br i1 %cond_$16, label %ifTrue_217, label %secondCond_67

secondCond_65:                                        ; pred = %next_357, %secondCond_66
  ...
  br i1 %cond_$15, label %ifTrue_216, label %next_358

secondCond_66:                                        ; pred = %next_357
  ...
  br i1 %cond_$14, label %ifTrue_216, label %secondCond_65

ifTrue_217:                                           ; pred = %next_358, %secondCond_68, %secondCond_68
  call void @putch(i32 75)
  br label %next_359

next_359:                                             ; pred = %secondCond_67, %secondCond_68, %secondCond_68, %ifTrue_217
  call void @putch(i32 10)
  ret i32 0

secondCond_67:                                        ; pred = %next_358
  ...
  br i1 %cond_$17, label %secondCond_68, label %next_359
...
secondCond_68:                                        ; pred = %secondCond_67
  ...
  br i1 %cond_$18, label %ifTrue_217, label %next_359
  %cond_normalize_$10 = icmp ne i32 0, 0
  br i1 %cond_normalize_$10, label %ifTrue_217, label %next_359
}
