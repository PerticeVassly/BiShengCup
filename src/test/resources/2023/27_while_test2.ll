...
whileCond_229:                                         ; pred = %FourWhileEntry, %next_565
  %a = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %a, 20
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_229, label %next_564
...
whileCond_230:                                         ; pred = %whileBody_229, %next_566
  %b = load i32, i32* %lv$1, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %b, 10
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_230, label %next_565
...
whileCond_231:                                         ; pred = %whileBody_230, %next_567
  %c = load i32, i32* %lv$2, align 4
  %cond_eq_tmp_ = icmp eq i32 %c, 7
  %cond_tmp_$2 = zext i1 %cond_eq_tmp_ to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %whileBody_231, label %next_566
...
whileCond_232:                                         ; pred = %whileBody_231, %whileBody_232
  ...
  br i1 %cond_$3, label %whileBody_232, label %next_567
