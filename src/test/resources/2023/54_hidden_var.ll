...
define i32 @main() {
mainEntry70:
  %m143 = getelementptr [4 x i32], [4 x i32]* @gv1, i32 0, i32 2
  %lv$5 = alloca [7 x [1 x [5 x i32]]], align 16
  %m142 = getelementptr [7 x [1 x [5 x i32]]], [7 x [1 x [5 x i32]]]* %lv$5, i32 0, i32 2
...
ifTrue_321:                                           ; pred = %next_578
  ...
  %ptr_$4 = getelementptr [1 x [5 x i32]], [1 x [5 x i32]]* %m142, i32 0, i32 0
...
next_580:                                             ; pred = %next_578, %ifTrue_321
  ...
  %c$14 = load i32, i32* %m143, align 4
