...
whileCond_58:                                        ; pred = %mainEntry18, %next_109
  %a$3 = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %a$3, 5
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_58, label %next_108
...
whileBody_58:                                        ; pred = %whileCond_58
  ...
  br i1 %cond_normalize_, label %ifTrue_50, label %next_109

next_108:                                            ; pred = %whileCond_58, %ifTrue_50
  ...
  br i1 %cond_normalize_$1, label %ifTrue_51, label %next_110

ifTrue_50:                                           ; pred = %whileBody_58
  br label %next_108
  br label %next_109

next_109:                                            ; pred = %whileBody_58, %ifTrue_50
  br label %whileCond_58

ifTrue_51:                                           ; pred = %next_108
...
next_110:                                            ; pred = %next_108, %ifTrue_51
  call void @putch(i32 10)
