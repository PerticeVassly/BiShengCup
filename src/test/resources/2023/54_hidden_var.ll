...
whileCond_162:                                        ; pred = %mainEntry70, %next_315
  %a$3 = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %a$3, 5
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_162, label %next_314
...
whileBody_162:                                        ; pred = %whileCond_162
  ...
  br i1 %cond_normalize_, label %ifTrue_152, label %next_315

next_314:                                             ; pred = %whileCond_162, %ifTrue_152
  ...
  br i1 %cond_normalize_$1, label %ifTrue_153, label %next_316

ifTrue_152:                                           ; pred = %whileBody_162
  br label %next_314
  br label %next_315

next_315:                                             ; pred = %whileBody_162, %ifTrue_152
  br label %whileCond_162

ifTrue_153:                                           ; pred = %next_314
...
next_316:                                             ; pred = %next_314, %ifTrue_153
  call void @putch(i32 10)
