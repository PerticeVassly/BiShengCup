...
whileCond_288:                                        ; pred = %funcEntry4, %whileBody_288
  %index = load i32, i32* %lv$9, align 4
  %cond_lt_tmp_ = icmp slt i32 %index, 10
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_288, label %next_658
...
whileCond_289:                                        ; pred = %next_658, %whileBody_289
  %i = load i32, i32* %lv$8, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %i, 10
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_289, label %next_659
