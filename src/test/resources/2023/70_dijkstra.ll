...
@gv = global i32 65535, align 4
@gv1 = global [16 x [16 x i32]] zeroinitializer, align 4
@gv2 = global [16 x i32] zeroinitializer, align 4
@gv3 = global [16 x i32] zeroinitializer, align 4
...
whileBody_44:                                         ; pred = %whileCond_44
  ...
  %dis = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %i$1
  %i$2 = load i32, i32* %lv, align 4
  %ptr_ = getelementptr [16 x [16 x i32]], [16 x [16 x i32]]* @gv1, i32 0, i32 1
  %e = getelementptr [16 x i32], [16 x i32]* %ptr_, i32 0, i32 %i$2
  %e$1 = load i32, i32* %e, align 4
  store i32 %e$1, i32* %dis, align 4
  %i$3 = load i32, i32* %lv, align 4
  %book = getelementptr [16 x i32], [16 x i32]* @gv2, i32 0, i32 %i$3
...
next_86:                                              ; pred = %whileCond_44
  %book$1 = getelementptr [16 x i32], [16 x i32]* @gv2, i32 0, i32 1
...
whileBody_45:                                         ; pred = %whileCond_45
  ...
  store i32 %INF, i32* %lv$2, align 4
...
whileBody_46:                                         ; pred = %whileCond_46
  ...
  %dis$1 = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %k$1
...
next_88:                                              ; pred = %whileCond_46
  ...
  %book$4 = getelementptr [16 x i32], [16 x i32]* @gv2, i32 0, i32 %min_index
...
ifTrue_42:                                            ; pred = %secondCond_32
  ...
  %dis$3 = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %k$3
...
secondCond_32:                                        ; pred = %whileBody_46
  ...
  %book$2 = getelementptr [16 x i32], [16 x i32]* @gv2, i32 0, i32 %k$2
...
whileBody_47:                                         ; pred = %whileCond_47
  ...
  %ptr_$1 = getelementptr [16 x [16 x i32]], [16 x [16 x i32]]* @gv1, i32 0, i32 %min_index$1
...
ifTrue_43:                                            ; pred = %whileBody_47
  ...
  %dis$5 = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %j$2
  %dis$6 = load i32, i32* %dis$5, align 4
  %min_index$2 = load i32, i32* %lv$3, align 4
  %dis$7 = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %min_index$2
  %dis$8 = load i32, i32* %dis$7, align 4
  %min_index$3 = load i32, i32* %lv$3, align 4
  %j$3 = load i32, i32* %lv$5, align 4
  %ptr_$2 = getelementptr [16 x [16 x i32]], [16 x [16 x i32]]* @gv1, i32 0, i32 %min_index$3
...
ifTrue_44:                                            ; pred = %ifTrue_43
  ...
  %dis$9 = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %j$4
  %min_index$4 = load i32, i32* %lv$3, align 4
  %dis$10 = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %min_index$4
  %dis$11 = load i32, i32* %dis$10, align 4
  %min_index$5 = load i32, i32* %lv$3, align 4
  %j$5 = load i32, i32* %lv$5, align 4
  %ptr_$3 = getelementptr [16 x [16 x i32]], [16 x [16 x i32]]* @gv1, i32 0, i32 %min_index$5
...
mainEntry17:
  ...
  store i32 %getint$1, i32* @gv5, align 4
  store i32 1, i32* %lv, align 4
...
ifTrue_45:                                           ; pred = %whileBody_49
  ...
  %ptr_ = getelementptr [16 x [16 x i32]], [16 x [16 x i32]]* @gv1, i32 0, i32 %i$2
...
ifFalse_14:                                          ; pred = %whileBody_49
  ...
  %ptr_$1 = getelementptr [16 x [16 x i32]], [16 x [16 x i32]]* @gv1, i32 0, i32 %i$3
...
whileBody_50:                                        ; pred = %whileCond_50
  ...
  %ptr_$2 = getelementptr [16 x [16 x i32]], [16 x [16 x i32]]* @gv1, i32 0, i32 %u
...
whileBody_51:                                        ; pred = %whileCond_51
  ...
  %dis = getelementptr [16 x i32], [16 x i32]* @gv3, i32 0, i32 %i$8
