...
whileCond_225:                                          ; pred = %long_arrayEntry, %whileBody_225
  ...
  br i1 %cond_, label %whileBody_225, label %next_552
...
next_552:                                               ; pred = %whileCond_225
  store i32 0, i32* %lv$4, align 4
  br label %whileCond_226

whileCond_226:                                          ; pred = %next_552, %whileBody_226
  %i$5 = load i32, i32* %lv$4, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %i$5, 10000
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_226, label %next_553
...
next_553:                                               ; pred = %whileCond_226
  store i32 0, i32* %lv$4, align 4
  br label %whileCond_227

whileCond_227:                                          ; pred = %next_553, %whileBody_227
  %i$10 = load i32, i32* %lv$4, align 4
  %cond_lt_tmp_$2 = icmp slt i32 %i$10, 10000
  %cond_tmp_$2 = zext i1 %cond_lt_tmp_$2 to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %whileBody_227, label %next_554
...
whileBody_228:                                          ; pred = %whileCond_228
  ...
  br i1 %cond_$4, label %ifTrue_327, label %ifFalse_127

next_555:                                               ; pred = %whileCond_228
  %ans$8 = load i32, i32* %lv$5, align 4
  ret i32 %ans$8

ifTrue_327:                                             ; pred = %whileBody_228
...
ifFalse_128:                                            ; pred = %ifFalse_127
  ...
  br i1 %cond_$7, label %ifTrue_329, label %ifFalse_129

next_557:                                               ; pred = %next_558, %next_559
  br label %next_556

whileCond_229:                                          ; pred = %ifTrue_328, %whileBody_229
  %j = load i32, i32* %lv$6, align 4
  %cond_lt_tmp_$6 = icmp slt i32 %j, 10000
  %cond_tmp_$6 = zext i1 %cond_lt_tmp_$6 to i32
  %cond_$6 = icmp ne i32 %cond_tmp_$6, 0
  br i1 %cond_$6, label %whileBody_229, label %next_558
...
next_559:                                               ; pred = %next_560, %ifFalse_129
  br label %next_557

whileCond_230:                                          ; pred = %ifTrue_329, %next_561
  ...
  br i1 %cond_$8, label %whileBody_230, label %next_560
...
whileBody_230:                                          ; pred = %whileCond_230
  ...
  br i1 %cond_$9, label %ifTrue_330, label %ifFalse_130

next_560:                                               ; pred = %whileCond_230
  %ans$6 = load i32, i32* %lv$5, align 4
  call void @putint(i32 %ans$6)
  br label %next_559

ifTrue_330:                                             ; pred = %whileBody_230
...
ifFalse_130:                                            ; pred = %whileBody_230
...
next_561:                                               ; pred = %ifTrue_330, %ifFalse_130
  br label %whileCond_230
}
