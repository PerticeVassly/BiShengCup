...
inline2146:                                          ; pred = %inline2145
  %get_one_of_inline2146 = load i32, i32* %retVal_ofinline2134_of_inline2135, align 4
  %cond_eq_tmp__of_inline2146 = icmp eq i32 %get_one_of_inline2146, 1
  %cond_tmp_$3_of_inline2146 = zext i1 %cond_eq_tmp__of_inline2146 to i32
  %cond_$3_of_inline2146 = icmp ne i32 %cond_tmp_$3_of_inline2146, 0
  br i1 %cond_$3_of_inline2146, label %inline2143, label %inline2144
...
inline2135:                                          ; pred = %mainEntry79
  %result__of_inline2135 = add i32 %p, %p$1
