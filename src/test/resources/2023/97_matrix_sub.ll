...
whileCond_208:                                        ; pred = %subEntry, %whileBody_208
  %i = load i32, i32* %lv$9, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, 3
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_208, label %next_518
...
whileCond_209:                                        ; pred = %mainEntry67, %whileBody_209
  %i = load i32, i32* %lv$9, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, 3
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_209, label %next_519
...
whileCond_210:                                        ; pred = %next_519, %whileBody_210
  %i$14 = load i32, i32* %lv$9, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %i$14, 3
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_210, label %next_520
...
whileCond_211:                                        ; pred = %next_520, %whileBody_211
  %i$17 = load i32, i32* %lv$9, align 4
  %cond_lt_tmp_$2 = icmp slt i32 %i$17, 3
  %cond_tmp_$2 = zext i1 %cond_lt_tmp_$2 to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %whileBody_211, label %next_521
...
whileCond_212:                                        ; pred = %next_521, %whileBody_212
  %i$20 = load i32, i32* %lv$9, align 4
  %cond_lt_tmp_$3 = icmp slt i32 %i$20, 3
  %cond_tmp_$3 = zext i1 %cond_lt_tmp_$3 to i32
  %cond_$3 = icmp ne i32 %cond_tmp_$3, 0
  br i1 %cond_$3, label %whileBody_212, label %next_522
