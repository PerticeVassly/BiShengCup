...
relu_regEntry:
  ...
  br i1 %cond_, label %ifTrue_287, label %next_463

ifTrue_287:                                           ; pred = %relu_regEntry
  ret i32 127

next_463:                                             ; pred = %relu_regEntry
  %a$1 = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %a$1, 0
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_288, label %next_464

ifTrue_288:                                           ; pred = %next_463
  ret i32 0

next_464:                                             ; pred = %next_463
...
modelEntry:
  ...
  %cond_tmp_ = zext i1 %cond_gt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_289, label %next_465

ifTrue_289:                                        ; pred = %modelEntry
  ret i32 1

next_465:                                          ; pred = %modelEntry
  ret i32 0
}
...
whileCond_176:                                        ; pred = %mainEntry44, %next_469
  %N = load i32, i32* %lv, align 4
  %cond_gt_tmp_ = icmp sgt i32 %N, 0
  %cond_tmp_ = zext i1 %cond_gt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_176, label %next_466

whileBody_176:                                        ; pred = %whileCond_176
  store i32 0, i32* %lv$2, align 4
  br label %whileCond_177

next_466:                                             ; pred = %whileCond_176
  ret i32 0

whileCond_177:                                        ; pred = %whileBody_176, %next_468
  %i = load i32, i32* %lv$2, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, 5
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_177, label %next_467

whileBody_177:                                        ; pred = %whileCond_177
  store i32 0, i32* %lv$3, align 4
  br label %whileCond_178

next_467:                                             ; pred = %whileCond_177
  ...
  br i1 %cond_normalize_, label %ifTrue_290, label %ifFalse_113

whileCond_178:                                        ; pred = %whileBody_177, %whileBody_178
  %j = load i32, i32* %lv$3, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %j, 5
  %cond_tmp_$2 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %whileBody_178, label %next_468
...
next_469:                                             ; pred = %ifTrue_290, %ifFalse_113
