...
relu_regEntry:
  ...
  br i1 %cond_, label %ifTrue_313, label %next_565

ifTrue_313:                                           ; pred = %relu_regEntry
  ret i32 127

next_565:                                             ; pred = %relu_regEntry
  %a$1 = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %a$1, 0
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_314, label %next_566

ifTrue_314:                                           ; pred = %next_565
  ret i32 0

next_566:                                             ; pred = %next_565
...
modelEntry:
  ...
  %cond_tmp_ = zext i1 %cond_gt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_315, label %next_567

ifTrue_315:                                        ; pred = %modelEntry
  ret i32 1

next_567:                                          ; pred = %modelEntry
  ret i32 0
}
...
whileCond_252:                                        ; pred = %mainEntry68, %next_571
  %N = load i32, i32* %lv, align 4
  %cond_gt_tmp_ = icmp sgt i32 %N, 0
  %cond_tmp_ = zext i1 %cond_gt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_252, label %next_568

whileBody_252:                                        ; pred = %whileCond_252
  store i32 0, i32* %lv$2, align 4
  br label %whileCond_253

next_568:                                             ; pred = %whileCond_252
  ret i32 0

whileCond_253:                                        ; pred = %whileBody_252, %next_570
  %i = load i32, i32* %lv$2, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, 5
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_ to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_253, label %next_569

whileBody_253:                                        ; pred = %whileCond_253
  store i32 0, i32* %lv$3, align 4
  br label %whileCond_254

next_569:                                             ; pred = %whileCond_253
  ...
  br i1 %cond_normalize_, label %ifTrue_316, label %ifFalse_138

whileCond_254:                                        ; pred = %whileBody_253, %whileBody_254
  %j = load i32, i32* %lv$3, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %j, 5
  %cond_tmp_$2 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %whileBody_254, label %next_570
...
next_571:                                             ; pred = %ifTrue_316, %ifFalse_138
