...
whileCond_:                                             ; pred = %quick_readEntry, %next_1
  %ch = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %ch, 48
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_, label %secondCond_

whileBody_:                                             ; pred = %whileCond_, %secondCond_
...
whileCond_1:                                            ; pred = %next_, %whileBody_1
  ...
  br i1 %cond_$3, label %secondCond_1, label %next_2

whileBody_1:                                            ; pred = %secondCond_1
...
next_2:                                                 ; pred = %whileCond_1, %secondCond_1
  %f = load i32, i32* %lv$2, align 4
  %cond_normalize_ = icmp ne i32 %f, 0
  br i1 %cond_normalize_, label %ifTrue_1, label %ifFalse_

secondCond_1:                                           ; pred = %whileCond_1
  %ch$4 = load i32, i32* %lv, align 4
  %cond_le_tmp_ = icmp sle i32 %ch$4, 57
  %cond_tmp_$4 = zext i1 %cond_le_tmp_ to i32
  %cond_$4 = icmp ne i32 %cond_tmp_$4, 0
  br i1 %cond_$4, label %whileBody_1, label %next_2

ifTrue_1:                                               ; pred = %next_2
  %x$1 = load i32, i32* %lv$1, align 4
  %tmp_ = sub i32 0, %x$1
  ret i32 %tmp_

ifFalse_:                                               ; pred = %next_2
...
whileCond_2:                                        ; pred = %initEntry, %whileBody_2
...
whileCond_3:                                        ; pred = %sameEntry, %next_7
  %h = load i32, i32* @gv7, align 4
  %tail = load i32, i32* @gv8, align 4
...
whileBody_3:                                        ; pred = %whileCond_3
  ...
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %ifTrue_2, label %next_6

next_5:                                             ; pred = %whileCond_3
  store i32 0, i32* %lv$5, align 4
  br label %whileCond_5

ifTrue_2:                                           ; pred = %whileBody_3
  store i32 1, i32* %lv$2, align 4
  br label %next_6

next_6:                                             ; pred = %whileBody_3, %ifTrue_2
...
whileBody_4:                                        ; pred = %whileCond_4
  ...
  br i1 %cond_normalize_, label %ifTrue_3, label %next_8

next_7:                                             ; pred = %whileCond_4
  br label %whileCond_3

ifTrue_3:                                           ; pred = %whileBody_4
...
next_8:                                             ; pred = %whileBody_4, %ifTrue_3
...
whileCond_6:                                         ; pred = %mainEntry, %next_12
  %m = load i32, i32* @gv1, align 4
  %cond_normalize_ = icmp ne i32 %m, 0
  br i1 %cond_normalize_, label %whileBody_6, label %next_10
...
whileCond_7:                                         ; pred = %whileBody_6, %whileBody_7
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %secondCond_2, label %next_11

whileBody_7:                                         ; pred = %secondCond_2
  %getch$1 = call i32 @getch()
  store i32 %getch$1, i32* %lv, align 4
  br label %whileCond_7

next_11:                                             ; pred = %whileCond_7, %secondCond_2
  %ch$2 = load i32, i32* %lv, align 4
  %cond_eq_tmp_ = icmp eq i32 %ch$2, 81
  %cond_tmp_$2 = zext i1 %cond_eq_tmp_ to i32
  %cond_$2 = icmp ne i32 %cond_tmp_$2, 0
  br i1 %cond_$2, label %ifTrue_4, label %ifFalse_1

secondCond_2:                                        ; pred = %whileCond_7
  %ch$1 = load i32, i32* %lv, align 4
  %cond_neq_tmp_$1 = icmp ne i32 %ch$1, 85
  %cond_tmp_$1 = zext i1 %cond_neq_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_7, label %next_11

ifTrue_4:                                            ; pred = %next_11
...
next_12:                                             ; pred = %ifTrue_4, %ifFalse_1
