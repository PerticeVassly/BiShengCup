...
whileCond_27:                                        ; pred = %mainEntry6, %next_58
  %i = load i32, i32* %lv$1, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, 3
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_27, label %next_57
...
next_57:                                             ; pred = %whileCond_27
  %a$1 = load i32, i32* %lv, align 4
  ret i32 %a$1

whileCond_28:                                        ; pred = %whileBody_27, %next_59
  %j = load i32, i32* %lv$2, align 4
  %cond_lt_tmp_$1 = icmp slt i32 %j, 4
  %cond_tmp_$1 = zext i1 %cond_lt_tmp_$1 to i32
  %cond_$1 = icmp ne i32 %cond_tmp_$1, 0
  br i1 %cond_$1, label %whileBody_28, label %next_58
...
whileCond_35:                                        ; pred = %whileBody_34, %next_66
  ...
  br i1 %cond_$8, label %whileBody_35, label %next_65
...
whileCond_36:                                        ; pred = %whileBody_35, %next_67
  ...
  br i1 %cond_$9, label %whileBody_36, label %next_66
...
whileCond_37:                                        ; pred = %whileBody_36, %next_68
  ...
  br i1 %cond_$10, label %whileBody_37, label %next_67
...
whileCond_38:                                        ; pred = %whileBody_37, %next_69
  ...
  br i1 %cond_$11, label %whileBody_38, label %next_68
...
whileCond_39:                                        ; pred = %whileBody_38, %next_70
  ...
  br i1 %cond_$12, label %whileBody_39, label %next_69
...
whileCond_40:                                        ; pred = %whileBody_39, %next_71
  ...
  br i1 %cond_$13, label %whileBody_40, label %next_70
...
whileCond_41:                                        ; pred = %whileBody_40, %whileBody_41
  ...
  br i1 %cond_$14, label %whileBody_41, label %next_71
