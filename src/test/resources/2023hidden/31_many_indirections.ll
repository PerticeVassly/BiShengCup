...
whileCond_20:                                        ; pred = %mainEntry4, %next_43
  %i = load i32, i32* %lv, align 4
  %cond_lt_tmp_ = icmp slt i32 %i, 20
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %whileBody_20, label %next_42

whileBody_20:                                        ; pred = %whileCond_20
  store i32 0, i32* %lv$2, align 4
  br label %whileCond_21

next_42:                                             ; pred = %whileCond_20
...
whileCond_21:                                        ; pred = %whileBody_20, %whileBody_21
  ...
  br i1 %cond_$1, label %whileBody_21, label %next_43
