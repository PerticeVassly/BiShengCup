...
findEntry:
  ...
  br i1 %cond_, label %ifTrue_4, label %ifFalse_3

ifTrue_4:                                         ; pred = %findEntry
  %root$2 = load i32, i32* %lv, align 4
  ret i32 %root$2

ifFalse_3:                                        ; pred = %findEntry
...
mergeEntry:
  ...
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_5, label %next_7

ifTrue_5:                                          ; pred = %mergeEntry
...
next_7:                                            ; pred = %mergeEntry, %ifTrue_5
  ret void
}
