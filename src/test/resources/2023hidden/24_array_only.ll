...
inc_implEntry:
  ...
  %rec$1 = load i32, i32* %rec, align 4
  %cond_eq_tmp_ = icmp eq i32 %rec$1, 0
...
ifTrue_:                                              ; pred = %inc_implEntry
  ...
  %arr_$1 = load i32*, i32** %x, align 4
  %x$2 = getelementptr i32, i32* %arr_$1, i32 0
  %x$3 = load i32, i32* %x$2, align 4
  %result_ = add i32 %x$3, 1
  store i32 %result_, i32* %x$1, align 4
  br label %next_

ifFalse_:                                             ; pred = %inc_implEntry
  %arr_$2 = load i32*, i32** %x, align 4
  %x$4 = getelementptr i32, i32* %arr_$2, i32 0
  %arr_$3 = load i32*, i32** %x, align 4
  %x$5 = getelementptr i32, i32* %arr_$3, i32 0
  %x$6 = load i32, i32* %x$5, align 4
  %result_$1 = mul i32 %x$6, 2
  store i32 %result_$1, i32* %x$4, align 4
  %x$7 = load i32*, i32** %x, align 4
  %rec$2 = load i32, i32* %rec, align 4
  %result_$2 = sub i32 %rec$2, 1
  call void @inc_impl(i32* %x$7, i32 %result_$2)
  br label %next_
...
incEntry:
  ...
  call void @inc_impl(i32* %x$1, i32 %k$1)
  ret void
}
...
ifTrue_1:                                             ; pred = %add_implEntry
  ...
  %x$2 = getelementptr i32, i32* %arr_$1, i32 0
  %x$3 = load i32, i32* %x$2, align 4
  %arr_$2 = load i32*, i32** %y, align 4
  %y$1 = getelementptr i32, i32* %arr_$2, i32 0
  %y$2 = load i32, i32* %y$1, align 4
  %result_ = add i32 %x$3, %y$2
  store i32 %result_, i32* %x$1, align 4
  br label %next_1
...
ifFalse_1:                                            ; pred = %add_implEntry
  ...
  %arr_$4 = load i32*, i32** %x, align 4
  %x$5 = getelementptr i32, i32* %arr_$4, i32 0
  %x$6 = load i32, i32* %x$5, align 4
  %result_$1 = mul i32 %x$6, 2
  store i32 %result_$1, i32* %x$4, align 4
  %x$7 = load i32*, i32** %x, align 4
  ...
  %rec$2 = load i32, i32* %rec, align 4
  %result_$2 = sub i32 %rec$2, 1
  call void @add_impl(i32* %x$7, i32* %y$3, i32 %result_$2)
  br label %next_1
...
addEntry:
  ...
  %k = getelementptr [1 x i32], [1 x i32]* @gv1, i32 0, i32 0
  %k$1 = load i32, i32* %k, align 4
  call void @add_impl(i32* %x$1, i32* %y$1, i32 %k$1)
  ret void
}
...
ifFalse_2:                                            ; pred = %sub_implEntry
  ...
  %rec$2 = load i32, i32* %rec, align 4
  %result_$2 = sub i32 %rec$2, 1
  call void @sub_impl(i32* %x$7, i32* %y$3, i32 %result_$2)
  br label %next_2
...
subEntry:
  ...
  %k = getelementptr [1 x i32], [1 x i32]* @gv1, i32 0, i32 0
  %k$1 = load i32, i32* %k, align 4
  call void @sub_impl(i32* %x$1, i32* %y$1, i32 %k$1)
  ret void
}
...
whileCond_:                                         ; pred = %mainEntry1, %next_5
