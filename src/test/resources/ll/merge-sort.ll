...
whileCond_3:                                        ; pred = %mergeEntry, %whileBody_3
...
whileCond_4:                                        ; pred = %next_3, %whileBody_4
...
whileCond_5:                                        ; pred = %next_4, %next_6
  ...
  br i1 %cond_2, label %secondCond_, label %next_5

whileBody_5:                                        ; pred = %secondCond_
...
next_5:                                             ; pred = %whileCond_5, %secondCond_
...
secondCond_:                                        ; pred = %whileCond_5
  ...
  br i1 %cond_3, label %whileBody_5, label %next_5

ifTrue_:                                            ; pred = %whileBody_5
...
whileCond_6:                                        ; pred = %next_5, %whileBody_6
  ...
  br i1 %cond_5, label %whileBody_6, label %next_7
...
whileCond_7:                                        ; pred = %next_7, %whileBody_7
  ...
  br i1 %cond_6, label %whileBody_7, label %next_8
...
mergeSortEntry:
  ...
  %cond_tmp_ = zext i1 %cond_lt_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_1, label %next_9
...
next_9:                                                ; pred = %mergeSortEntry, %ifTrue_1
  ret void
}
