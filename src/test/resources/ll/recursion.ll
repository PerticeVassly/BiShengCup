...
fibonacciEntry:
  ...
  br i1 %cond_, label %ifTrue_5, label %next_18

ifTrue_5:                                              ; pred = %fibonacciEntry
  ret float 0x0

next_18:                                               ; pred = %fibonacciEntry
  %n2 = load i32, i32* %n, align 4
  %cond_eq_tmp_1 = icmp eq i32 %n2, 1
  %cond_tmp_1 = zext i1 %cond_eq_tmp_1 to i32
  %cond_1 = icmp ne i32 %cond_tmp_1, 0
  br i1 %cond_1, label %ifTrue_6, label %next_19

ifTrue_6:                                              ; pred = %next_18
...
polyEntry:
  ...
  %cond_tmp_ = zext i1 %cond_eq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_7, label %next_20

ifTrue_7:                                         ; pred = %polyEntry
  ret float 0xbff0000000000000

next_20:                                          ; pred = %polyEntry
  %n2 = load i32, i32* %n, align 4
  %cond_eq_tmp_1 = icmp eq i32 %n2, 1
  %cond_tmp_1 = zext i1 %cond_eq_tmp_1 to i32
  %cond_1 = icmp ne i32 %cond_tmp_1, 0
...
sumRecursiveEntry:
  ...
  %cond_tmp_ = zext i1 %cond_eq_tmp_ to i32
  %cond_ = icmp ne i32 %cond_tmp_, 0
  br i1 %cond_, label %ifTrue_10, label %next_23

ifTrue_10:                                                ; pred = %sumRecursiveEntry
  %x1 = load float, float* %x, align 4
  %poly = call float @poly(float %x1, i32 0)
  ret float %poly

next_23:                                                  ; pred = %sumRecursiveEntry
  %x2 = load float, float* %x, align 4
  %n2 = load i32, i32* %n, align 4
