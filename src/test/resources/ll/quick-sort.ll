...
begin:                                                 ; pred = %partitionEntry, %end7
  %j1 = load i32, i32* %j, align 4
  %high2 = load i32, i32* %high, align 4
  %result_1 = sub i32 %high2, 1
  %cond = icmp sle i32 %j1, %result_1
  br i1 %cond, label %true6, label %end6
...
true6:                                                 ; pred = %begin
  ...
  %cond1 = icmp slt i32 %arr4, %pivot1
  br i1 %cond1, label %true7, label %false6
...
quick_sortEntry:
  ...
  %low1 = load i32, i32* %low, align 4
  %high1 = load i32, i32* %high, align 4
  %cond = icmp slt i32 %low1, %high1
  br i1 %cond, label %true8, label %false7

true8:                                                  ; pred = %quick_sortEntry
...
false7:                                                 ; pred = %quick_sortEntry
  br label %end8

end8:                                                   ; pred = %true8, %false7
  ret void
  %3 = fptosi float [6 x i32] [i32 10, i32 7, i32 8, i32 9, i32 1, i32 5] to i32
}
